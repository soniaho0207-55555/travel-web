...
const CITIES = [
  ...
  { category: 'secret', text: '珍宝馆往深处走有珍妃井旁的皇家澡堂遗址，90% 游客看完大殿就走错过了' }
      ...
      { name: '长城（八达岭段）', era: '秦·公元前214年', hookShort: '每块砖印着工匠姓名——比 ISO 早 22 个世纪的追溯制。', whyVisit: '北八楼的垛口高 1.7 米，比守军平均身高高一头——射击孔开在胸前，人贴墙就是全身掩体。每块青砖长 37 厘米、重 12 公斤，烧制时印着工匠和州县姓名——这套质量追溯制度比明代早 1600 年就在秦朝用过，比现代 ISO 早 22 个世纪。公元前 214 年蒙恬修第一版长城那年，亚历山大死后 109 年，他在巴克特里亚留下的希腊化王国刚开始铸佛像——东方用夯土断路，西方用石雕融合。八达岭这段是明代重修，砖缝糯米石灰浆比水泥更耐冻。日落前半小时登北十二楼，光掠过墙脊，山脊线像一条等高线打印出来的黑刃。', yearNum: -214, wiki: 'Great Wall of China', wikiImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/The_Great_Wall_of_China_at_Jinshanling.jpg/1920px-The_Great_Wall_of_China_at_Jinshanling.jpg', gradient: 'linear-gradient(135deg, #3D5A3E 0%, #8aad96 50%, #1a2d22 100%)', desc: '万里长城始建于春秋战国，总长度超过21,000公里，是人类历史上最伟大的建筑工程之一。', hours: '旺季 07:30—18:00；淡季 08:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '北 5 楼到北 8 楼之间的城墙转折处是最经典构图，避开正午逆光选上午 09:00-10:30 向北拍' // ✓ 锚点：具体方向北 5-8 楼 + 具体时间 09:00-10:30
      ...
      { name: '天坛', era: '明·1420年', hookShort: '站在天心石低声说话，殿堂像给你戴了一副耳机。', whyVisit: '祈年殿三层圆顶下，地面铺成四圈砖：里圈 9 块、二圈 18 块、三圈 27 块、四圈 36 块——每圈都是 9 的倍数，一路到九圈 81 块。皇帝站的那块正中石叫"天心石"，你低声说话，十二根金丝楠木柱构成的殿堂会把你的声音反射回来像戴着一副耳机。1420 年建这座祭坛时，葡萄牙航海家亨利王子刚把船推到非洲西岸——北京在算天的数字，里斯本在算海的距离。回音壁外墙 193 米，贴墙说话能传到对面——这不是玄机，是砖缝被工匠一遍遍糊平、墙面弧度精确到 2 度的结果。冬至清晨的斜光进圜丘坛时，石面会泛出淡淡血红色。', yearNum: 1420, wiki: 'Temple of Heaven', wikiImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/11_Temple_of_Heaven.jpg/1920px-11_Temple_of_Heaven.jpg', gradient: 'linear-gradient(135deg, #1A4A7A 0%, #4A90C4 50%, #0d2940 100%)', desc: '天坛是明清两代皇帝祭天祈谷的场所，祈年殿三层蓝色琉璃瓦攒尖顶，纯木榫卯结构，被誉为中国古代建筑的杰作。', hours: '公园 06:00—22:00；景区 08:00—17:30', ticket: {
  ...
  },
  {
    ...
    text: '祈年殿西侧 30 米白石栏杆处可以把三层琉璃瓦攒尖顶整个框进镜头，正南拍只能拍到圆殿半边' // ✓ 锚点：具体方向西侧 30 米 + 只有去过才知道
      ...
      { name: '颐和园', era: '清·1750年', hookShort: '长廊 14000 幅彩画没有一幅重复，是明清文学史的屋檐。', whyVisit: '长廊 728 米，绘有彩画 14000 幅，没有任何两幅重复——内容从《三国》《西游》到花鸟虫鱼，等于把整个明清文学史贴在了昆明湖边的屋檐下。1750 年乾隆为母亲钮祜禄氏祝寿建清漪园那年，狄德罗刚在编《百科全书》第一卷——东方用园林浓缩天下山川，西方用词条切碎知识。十七孔桥的石狮共 544 只，每次游人数都数不清，因为大狮子背上、胸前、爪下还藏着小狮子。1900 年八国联军进京时颐和园被抢了 34 天，铜麒麟肚子上至今还留着俄军刺刀划的"1900"字样。', yearNum: 1750, wiki: 'Summer Palace', wikiImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Summer_Palace_in_Beijing_10.jpg/1920px-Summer_Palace_in_Beijing_10.jpg', gradient: 'linear-gradient(135deg, #2D6A4F 0%, #74C69D 50%, #1B4332 100%)', desc: '颐和园占地约290万平方米，万寿山与昆明湖相映，长廊、佛香阁、十七孔桥构成中国皇家园林最后的绝唱。', hours: '旺季 06:30—18:00；淡季 07:00—17:00', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '红堡', era: '莫卧儿·1648年', hookShort: '墙上刻着："人间若有天堂，就是这里，就是这里，就是这里。"', whyVisit: '{tag: 莫卧儿·1648 年｜墙高 33 米·周 2.4 公里}\n\n红砂岩墙高【33 米】、周长【2.4 公里】——【1648】年沙贾汗迁都时工匠用焦特布尔【600 公里】外的红砂岩运来砌成，日落时整面外墙像一块烧红的铁。主门拉合尔门即每年【8 月 15 日】印度总理发表独立日讲话的位置，自【1947】年尼赫鲁起未变。\n\nDiwan-i-Am（公众大殿）的「孔雀宝座」原镶【108】颗红宝石、【116】颗祖母绿、【186 克拉】的光之山钻石——【1739】年波斯纳迪尔沙洗劫德里时带走，现在光之山在英女王王冠里。Diwan-i-Khas 墙上刻着波斯语：「如果人间有天堂，那就是这里，就是这里，就是这里。」三遍。\n\n同年清乾隆四年，北京正兴文字狱——东西两端都在用「文化统一」掩盖帝国焦虑，一个砸字，一个镶金。', yearNum: 1648, wiki: 'Red Fort', wikiImage: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Delhi-Red_Fort-Lahori_Gate-20080210.jpg/1920px-Delhi-Red_Fort-Lahori_Gate-20080210.jpg', gradient: 'linear-gradient(135deg, #8B1A1A 0%, #C94A2A 50%, #4A0A0A 100%)', desc: '莫卧儿皇帝沙贾汗建造的红砂岩宫殿，城墙高33米。每年独立日总理在此发表讲话。', hours: '09:30—16:30，周一闭馆', ticket: {

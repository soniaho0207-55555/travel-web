...
const CITIES = [
  {
    ...
    landmarks: [
      { name: '故宫（紫禁城）', era: '明·1420年', hookShort: '地面金砖每块 108 斤，烧两年，敲之有金玉之声。', whyVisit: '太和殿前的丹陛石上一条云龙自下往上攀——整块汉白玉长 16.57 米，重 200 余吨，1420 年冬天用千匹骡子在泼水冻成的冰道上拖了 28 天，从房山滑到紫禁城。地面铺的是苏州烧的"金砖"，每块 108 斤，烧制需两年，敲起来有金玉之声。同一年欧洲正陷黑死病第四波，佛罗伦萨的圣母百花大教堂穹顶刚开工——布鲁内莱斯基用飞扶壁撑石头，紫禁城用榫卯咬木材，两套对抗地心引力的方案隔着九千公里并行推进。殿内金銮宝座下的地砖被六百年皇帝的脚磨得发乌，光从隔扇透进来，灰尘在朱红柱影里浮。', yearNum: 1420, wiki: 'Hall of Supreme Harmony', gradient: 'linear-gradient(135deg, #8B1A1A 0%, #C9963A 50%, #2D1B00 100%)', desc: '紫禁城是明清两朝的皇家宫殿，南北长960米，东西宽753米，共有房屋九千余间，是世界上现存规模最大、保存最完整的木质结构古建筑群。', hours: '淡季 08:30—17:00；旺季 08:30—17:30，周一闭馆', ticket: {
  ...
  { category: 'secret', text: '珍宝馆往深处走有珍妃井旁的皇家澡堂遗址，90% 游客看完大殿就走错过了' }
      ...
      { name: '长城（八达岭段）', era: '秦·公元前214年', hookShort: '每块砖印着工匠姓名——比 ISO 早 22 个世纪的追溯制。', whyVisit: '北八楼的垛口高 1.7 米，比守军平均身高高一头——射击孔开在胸前，人贴墙就是全身掩体。每块青砖长 37 厘米、重 12 公斤，烧制时印着工匠和州县姓名——这套质量追溯制度比明代早 1600 年就在秦朝用过，比现代 ISO 早 22 个世纪。公元前 214 年蒙恬修第一版长城那年，亚历山大死后 109 年，他在巴克特里亚留下的希腊化王国刚开始铸佛像——东方用夯土断路，西方用石雕融合。八达岭这段是明代重修，砖缝糯米石灰浆比水泥更耐冻。日落前半小时登北十二楼，光掠过墙脊，山脊线像一条等高线打印出来的黑刃。', yearNum: -214, wiki: 'Great Wall of China', gradient: 'linear-gradient(135deg, #3D5A3E 0%, #8aad96 50%, #1a2d22 100%)', desc: '万里长城始建于春秋战国，总长度超过21,000公里，是人类历史上最伟大的建筑工程之一。', hours: '旺季 07:30—18:00；淡季 08:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '祈年殿西侧 30 米白石栏杆处可以把三层琉璃瓦攒尖顶整个框进镜头，正南拍只能拍到圆殿半边' // ✓ 锚点：具体方向西侧 30 米 + 只有去过才知道
      ...
      { name: '颐和园', era: '清·1750年', hookShort: '长廊 14000 幅彩画没有一幅重复，是明清文学史的屋檐。', whyVisit: '长廊 728 米，绘有彩画 14000 幅，没有任何两幅重复——内容从《三国》《西游》到花鸟虫鱼，等于把整个明清文学史贴在了昆明湖边的屋檐下。1750 年乾隆为母亲钮祜禄氏祝寿建清漪园那年，狄德罗刚在编《百科全书》第一卷——东方用园林浓缩天下山川，西方用词条切碎知识。十七孔桥的石狮共 544 只，每次游人数都数不清，因为大狮子背上、胸前、爪下还藏着小狮子。1900 年八国联军进京时颐和园被抢了 34 天，铜麒麟肚子上至今还留着俄军刺刀划的"1900"字样。', yearNum: 1750, wiki: 'Summer Palace', gradient: 'linear-gradient(135deg, #2D6A4F 0%, #74C69D 50%, #1B4332 100%)', desc: '颐和园占地约290万平方米，万寿山与昆明湖相映，长廊、佛香阁、十七孔桥构成中国皇家园林最后的绝唱。', hours: '旺季 06:30—18:00；淡季 07:00—17:00', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '科洛塞姆（斗兽场）', era: '公元72—80年', hookShort: '五万人十五分钟清场——现代体育场也没拉开多少。', whyVisit: '第一排观众离第一滴血只有四米。大理石坐席按等级从下往上排开，皇帝席与地面持平，女眷与奴隶被推到顶层第五环——一座石头堆成的帝国切片。八十座出口的编号至今还刻在拱门楣上，工程师测算过：五万人十五分钟清场，这速度现代体育场也没拉开多少。公元 80 年落成那年，洛阳的东汉白马寺刚迎来第一批天竺僧人——两座城同在为"看什么"建房子，一边看殉道，一边看搏杀。风从废掉的地板缝漏上来，你站的位置当年是活门，下面是豹子和角斗士共用的等候间。', yearNum: 80, wiki: 'Colosseum', gradient: 'linear-gradient(135deg, #5C3317 0%, #C9963A 50%, #2A1500 100%)', desc: '科洛塞姆是罗马帝国修建的椭圆形竞技场，长轴188米、高约50米，其拱券结构深刻影响了西方建筑两千年。', hours: '09:00—19:00（夏季延至20:00）', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '圣索菲亚大教堂', era: '拜占庭·537年', hookShort: '做过一千年教堂，五百年清真寺，现在在做第三件事。', whyVisit: '抬头看穹顶基座，一圈 40 扇小窗连成光环，让 31 米直径的穹顶看起来像悬浮半空——查士丁尼的工匠砌到一半塌了两次，第三次才学会让骨料用更轻的罗德岛浮岩。537 年落成那年，南梁武帝在同泰寺舍身出家第三次——东西两端的皇帝都在用宗教包装权力。1453 年穆罕默德二世进城后命工匠把圣母像用薄石膏盖上，九百年没拆。1935 年石膏剥落时圣母的金色眼睛从下面看出来，和麦加方向的金字叠在一个画面里。2020 年它又改回清真寺，现在非礼拜时段进去，地毯铺在原来的大理石马赛克地面上，你能感觉脚下的层。', yearNum: 537, wiki: 'Hagia Sophia', gradient: 'linear-gradient(135deg, #4A2C0A 0%, #D4841A 45%, #C9963A 100%)', desc: '圣索菲亚是拜占庭建筑的顶峰之作，近千年来一直是世界上最大的教堂。', hours: '礼拜时间外开放 09:00—17:30', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '伏见稻荷大社', era: '奈良·711年', hookShort: '一万座鸟居柱脚都刻着供奉者，从 1911 年排到上月。', whyVisit: '山道上一万座朱红鸟居，每一座都是家族或企业捐的——柱脚黑漆小字刻着供奉者姓名和年月，从 1911 年一直排到上个月。最小的一座 5 万日元起捐，最大的"大鸟居"由前一代持有家族负责维修——日本公司能活一百年不稀奇，这里半数立柱的主人家比股票代码还长寿。711 年奈良时代建社那年，是开元盛世前五年——中日两边的皇帝都在用神给权力盖章。狐狸石像口中叼的四样不同：稻穗（五谷）、钥匙（粮仓）、卷轴（智慧）、宝珠（灵魂）——谁占哪样，捐立者自选。凌晨 4 点到 6 点走千本鸟居，朱红在黑色山道里像一条体温管子，耳边只有自己鞋底踩松针的声。', yearNum: 711, wiki: 'Fushimi Inari-taisha', gradient: 'linear-gradient(135deg, #7A1A0A 0%, #E84A1A 50%, #3D0D00 100%)', desc: '全日本3万余座稻荷神社的总本社，山道上绵延约4公里、多达10,000座朱红色鸟居。', hours: '24小时开放', ticket: {
  price: '免费；24 小时开放',
  channels: [
    {
      name: '官方 inari.jp',
  ...
  },
  {
    ...
    landmarks: [
      { name: '吉萨大金字塔群', era: '古王国·约前2560年', hookShort: '底边四角误差不超 5 厘米——只靠日影和水面。', whyVisit: '胡夫金字塔由约 230 万块石灰岩砌成，底部四个边长误差不超过 5 厘米——现代 GPS 才能达到的精度，公元前 2560 年的工匠只凭日影和水面校准就做到了。从北面盗墓者通道钻进去，爬到国王墓室要 60 米，空气里是 4500 年的花岗石粉尘。同时期的东方还在夏朝建立前约 450 年，黄河流域的龙山文化刚开始烧制黑陶——一边用石头抵抗遗忘，一边用陶土装纳饮食。金字塔原本外覆一层白色图拉石灰岩，抛光到能反光——阿拉伯人陆续剥去建开罗的清真寺，现在顶部还能看到一小块残存，日落时那块会亮得刺眼。狮身人面像的鼻子是 14 世纪一位苏菲派修士用锤子砸的。', yearNum: -2560, wiki: 'Giza pyramid complex', gradient: 'linear-gradient(135deg, #4A3A1A 0%, #C9963A 45%, #8B6914 100%)', desc: '古代世界七大奇迹中唯一留存至今。胡夫金字塔使用约230万块石块，四个底边误差不超过5厘米。', hours: '08:00—17:00', ticket: {
  ...
  // ─── P1 CITIES ───────────────────────
  {
    ...
    landmarks: [
      { name: '巴黎圣母院', era: '中世纪·1163年', hookShort: '1500 尊石像，都是匿名石匠按邻居的脸刻的。', whyVisit: '西立面三座大门雕刻共 1500 多个人像，每一尊都是中世纪匿名石匠按邻居脸刻的——所谓"石头上的《圣经》"是给不识字者看的漫画书。1163 年动工时，南宋刚建立 36 年，岳飞冤死 21 年——东方用《资治通鉴》把历史记下来，西方用石头把信仰刻下来。飞扶壁是歌特式最激进的发明：外墙被掏空塞满玫瑰花窗，压力全由外侧几十条拱形石梁接住，让彩色玻璃在 12 世纪屋顶下合法存在。2019 年 4 月 15 日 18:43 火从屋顶阁楼铅皮下燃起，900 年橡木屋架——"森林"，每根梁来自一棵单独的橡树——一夜烧尽。消防员在 21:45 保住双塔，钟声响起时整个西岱岛街道跪满人。修复用的是从法国各地重新砍伐的 2000 棵橡树。', yearNum: 1163, wiki: 'Notre-Dame de Paris', gradient: 'linear-gradient(135deg, #2A2A3A 0%, #6A6A8B 50%, #1A1A2A 100%)', desc: '哥特式建筑的杰作，飞扶壁和玫瑰花窗是中世纪工程与艺术的巅峰。2019年大火后正在修复中。', hours: '修复中，部分区域开放', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '帕特农神庙', era: '古典·前447年', hookShort: '希腊人已知：直柱显凸肚，向内倾反而显直。', whyVisit: '柱子微微向内倾斜——每根朝中心倾约 7 厘米，如果把 46 根立柱向上延伸 2.4 公里，它们会交汇到天空中一点。这不是装饰，是"视觉修正"：人眼看直柱显凸肚，向内倾反而显直——公元前 447 年的希腊人已懂视知觉。雕带原有 115 米浮雕"泛雅典节游行"，1801 年英国大使埃尔金伯爵强拆 75 米运回伦敦，至今在大英博物馆二层。同期东方春秋末战国初，范蠡辅助越王勾践灭吴——东西两端都在打造"城邦对城邦"的世界格局。神庙内曾立 12 米高的雅典娜金象牙像，1200 公斤黄金，拜占庭时期被拆，一半金子做了君士坦丁堡的王冠。落日时多立克柱上的金黄色是大理石氧化后的铁锈斑，不是涂装。', yearNum: -447, wiki: 'Parthenon', gradient: 'linear-gradient(135deg, #4A3A2A 0%, #C9A96A 50%, #2A1A0A 100%)', desc: '供奉雅典娜女神的神庙，多立克柱式的完美典范。柱子微微向内倾斜以修正视觉错觉，精确度令现代建筑师惊叹。', hours: '08:00—20:00（夏季）', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '圣母百花大教堂', era: '文艺复兴·1436年', hookShort: '不用飞扶壁、不用木支架——他在万神殿躺了三天。', whyVisit: '布鲁内莱斯基设计的穹顶 45.5 米直径，不使用飞扶壁、不使用木质支架——他拿罗马万神殿当实物教材，悄悄在那里躺了三天，然后发明了"双层穹顶"结构和"鱼骨砖"铺法，让每一层砖都能支撑自己不塌。1436 年封顶那年，明宣德元年刚过，郑和已辞世一年——中国的远洋时代结束，西方的建筑革命才开始。登顶 463 级狭窄石阶，中间一段必须侧身——这是刻意保留的挤压感，布鲁内莱斯基让你感受他那 16 年如何一砖一砖把自己挤到天堂。外墙白、绿、粉三色大理石来自卡拉拉、普拉托、马雷马——托斯卡纳自己的地质切片。', yearNum: 1436, wiki: 'Florence Cathedral', gradient: 'linear-gradient(135deg, #8B4A2A 0%, #D4841A 50%, #4A2A0A 100%)', desc: '布鲁内莱斯基设计的穹顶直径45米，不使用飞扶壁，至今仍是最大的砖砌穹顶。他甚至为此发明了新的建造机械。', hours: '10:00—17:00', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '秦始皇兵马俑', era: '秦·前210年', hookShort: '青铜剑覆铬盐膜，秦人比德国人早了 2200 年。', whyVisit: '八千陶俑没有两张相同的脸——发髻、胡须、眉毛、表情、身材高矮都按真人复刻，考古学家 2010 年用三维比对发现俑脸与今陕西户县、蓝田当地人面部特征高度重合：就是秦军本人的戳样。每个俑原本都彩绘，出土 30 秒内氧化褪色。一号坑 230 米长，步兵方阵前三排无铠甲——是死士。兵器坑出土的青铜剑剑身覆 10-15 微米铬盐氧化膜，20 世纪 30 年代德国才申请到这项防锈专利——秦人早了 2200 年。同期西方，罗马正进第二次布匿战争，汉尼拔刚越过阿尔卑斯山——东西两端的军事革命同时进行，一边埋进土，一边打出来。', yearNum: -210, wiki: 'Terracotta Army', gradient: 'linear-gradient(135deg, #4A3A1A 0%, #8B7A5A 50%, #2A1A0A 100%)', desc: '1974年偶然发现的地下军团，约8000个真人大小的陶俑，每个面容各异。被誉为“世界第八大奇迹”。', hours: '08:30—18:00', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '红堡', era: '莫卧儿·1648年', hookShort: '墙上刻着："人间若有天堂，就是这里，就是这里，就是这里。"', whyVisit: '红砂岩墙高 33 米、周长 2.4 公里——1648 年沙贾汗迁都时工匠用焦特布尔 600 公里外的红砂岩运来砌成，日落时整面外墙像一块烧红的铁。主门拉合尔门即每年 8 月 15 日印度总理发表独立日讲话的位置，自 1947 年尼赫鲁起未变。Diwan-i-Am（公众大殿）的"孔雀宝座"原镶 108 颗红宝石、116 颗祖母绿、186 克拉的光之山钻石——1739 年波斯纳迪尔沙洗劫德里时带走，现在光之山在英女王王冠中。同年清乾隆四年，北京正兴文字狱——东西两端都在用"文化统一"掩盖帝国焦虑。Diwan-i-Khas 墙上刻着波斯语："如果人间有天堂，那就是这里，就是这里，就是这里。"三遍。', yearNum: 1648, wiki: 'Red Fort', gradient: 'linear-gradient(135deg, #8B1A1A 0%, #C94A2A 50%, #4A0A0A 100%)', desc: '莫卧儿皇帝沙贾汗建造的红砂岩宫殿，城墙高33米。每年独立日总理在此发表讲话。', hours: '09:30—16:30，周一闭馆', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '西墙（哭墙）', era: '前19年', hookShort: '最底一层 570 吨的石块——至今没人解释怎么搬上去。', whyVisit: '不是圣殿本体，只是第二圣殿外围护墙西段——488 米长的原墙地表可见仅 57 米。最底七层是希律王公元前 19 年扩建时的石块，最大一块重 570 吨，至今没人解释用什么机械搬上去。上面四层是倭马亚 7 世纪砌的小石块，再上面是奥斯曼 16 世纪的更小石块——这面墙本身是一部三教叠加的地质学。同年东方汉成帝河平三年，王莽正往上爬——一边帝国要亡，一边圣殿要建。塞纸条的习俗起于 18 世纪，现在每年 100 万张，每半年由拉比收出来埋到橄榄山上——不可烧、不可扔。男女分区由隔板隔开，女区只占 25%。', yearNum: -19, wiki: 'Western Wall', gradient: 'linear-gradient(135deg, #4A3A2A 0%, #8B7A5A 50%, #2A1A0A 100%)', desc: '第二圣殿仅存的遗迹，犹太教最神圣的祈祷场所。信徒将祈祷纸条塞入墙缝已有数百年传统。', hours: '24小时开放', ticket: {
  price: '免费 · 24 小时开放',
  channels: [
  ...
  },
  {
    ...
    landmarks: [
      { name: '吴哥窟主殿', era: '高棉·约1150年', hookShort: '被遗忘四百年，1861 年法国博物学家才重新推开丛林。', whyVisit: '护城河宽 190 米、全长 5.5 公里——环绕一座石头城市的水道宽得可以当运河走船。主殿中央塔 65 米高，与四座副塔共同象征"须弥山五峰"。日出时从西门进入，走 350 米西参道到荷花池东岸，五塔尖的倒影正好落在水面——柬埔寨国旗的图案就是这个角度。约 1150 年建成动用 30 万工匠、6000 头大象；同期南宋绍兴二十年，秦桧刚死五年；西方第二次十字军东征刚失败——东西两端都在打仗，中南半岛丛林里却完成了人类史上最大的宗教建筑。浮雕回廊长 800 米——"搅乳海"一段，阿修罗与天神用蛇拽住须弥山转 1000 年挤出甘露。1432 年后此都被遗忘 400 年，1861 年法国博物学家亨利·穆奥才重新发现它。', yearNum: 1150, wiki: 'Angkor Wat', gradient: 'linear-gradient(135deg, #2A3A1A 0%, #6B8A4A 50%, #1A2A0A 100%)', desc: '世界最大的宗教建筑，护城河宽190米，中央塔高65米。日出时五座塔尖的倒影是柬埔寨国旗的灵感来源。', hours: '05:00—17:30', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '德吉玛·艾尔法纳广场', era: '11世纪起', hookShort: '一把老虎钳一只锡盆——街头拔牙师至今真的存在。', whyVisit: '白天这里是市集、药草贩、耍蛇人、拔牙师——街头拔牙师至今真的存在，一把老虎钳一只锡盆，一颗牙 20 迪拉姆。入夜后广场 180 度转台：100 多个食摊 30 分钟内搭起，每摊编号，各家只做一两样——蜗牛汤、羊头、烤沙丁鱼——"专攻一菜"的密度地中海独一份。2001 年联合国教科文组织把它列入首批 19 项"人类口头非遗"，理由是 Halqa 讲故事传统：讲古人围圈传承的柏柏尔语故事一旦讲完就没了。11 世纪建城同期北宋庆历年间，包拯刚任开封府尹——一边把故事写进《清明上河图》，一边讲进沙漠夜空。日落时整个广场的音响从远到近一齐翻起，是非洲最古老的人声浪。', yearNum: 1050, wiki: 'Jemaa el-Fnaa', gradient: 'linear-gradient(135deg, #4A2A0A 0%, #C9763A 50%, #2A1A00 100%)', desc: '北非最繁忙的广场，白天是市集，入夜后变成露天大排档和表演场。联合国教科文组织将其列为“人类口头和非物质文化遗产”。', hours: '全天（夜晚最热闹）', ticket: {
  price: '完全免费；夜市摊位消费另计',
  channels: [
  ...
  },
  {
    ...
    landmarks: [
      { name: '大神庙遗址', era: '阿兹特克·1325年', hookShort: '1978 年一个电工挖电缆，锄头砸中 8 吨重的月亮女神。', whyVisit: '1978 年 2 月 21 日一个电工在大教堂旁边挖电缆，锄头砸中一块 8 吨重圆石——科约尔沙乌基（月亮女神）浮雕，直径 3.25 米。这块石头引出整座大神庙——阿兹特克首都特诺奇蒂特兰的心脏，1521 年被科尔特斯拆毁用来砌大教堂，埋了 450 年没人知道。金字塔原高 60 米，七次扩建，每次把前一版整个包进去——考古学家今天可以像洋葱一样剥开看。塔顶两座神庙，雨神与战神，祭司每年活祭上万人，心脏从活人胸口挖出举向太阳。1521 年陷落同期中国明嘉靖元年，王阳明刚病逝，心学在江南传开——东西两端都在整理"人与天的关系"，一边用哲学，一边用血。', yearNum: 1325, wiki: 'Coyolxauhqui Stone', gradient: 'linear-gradient(135deg, #4A2A0A 0%, #8B5A2A 50%, #2A1A00 100%)', desc: '阿兹特克帝国最重要的宗教建筑遗址，1978年偶然出土。金字塔式神庙曾高60米，供奉雨神和战神。', hours: '09:00—17:00，周一闭馆', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '马丘比丘遗址', era: '印加·约1450年', hookShort: '石缝之间插不进一张纸——不用任何砂浆。', whyVisit: '海拔 2430 米山脊上，整座城 550 米长、200 多座石构建筑——1450 年帕查库提下令建造时，选址第一原则是"谁也找不到"。石头之间不用任何砂浆或金属，只用"干缝石工"：大块花岗岩被打磨到彼此严丝合缝，任何一道缝插不进一张纸。西班牙工程师 1540 年代看过之后写信回马德里："我们的建筑师在这里是学生。"1450 年东方是明景泰元年，于谦刚打退瓦剌——东西两端都在用石头抵抗外部威胁。西班牙征服者从未发现这里，印加人大概在 1572 年主动弃城。1911 年 7 月 24 日耶鲁讲师宾厄姆被 11 岁农童 Pablito 带上山顶，推开一丛灌木看到石角。凌晨 6:30 从守卫屋平台看太阳门，云海卡在半山。', yearNum: 1450, wiki: 'Machu Picchu', gradient: 'linear-gradient(135deg, #0A2A1A 0%, #3A6A4A 50%, #051A0D 100%)', desc: '海拔 2430 米山脊上的印加皇家庄园，1450 年由帕查库提下令建造，1911 年被海勒姆·宾厄姆重新发现。整片遗址约 550 米长，含 200 多座石构建筑，精密的梯田 + 水道系统是印加工程的巅峰。', hours: '06:00—17:00', ticket: {

...
const CITIES = [
  {
    ...
    landmarks: [
      { name: '故宫（紫禁城）', era: '明·1420年', hookShort: '地面金砖每块 108 斤，烧两年，敲之有金玉之声。', whyVisit: '{tag: 明·1420 年｜9000 间宫殿}\n\n时间把石头磨出包浆，这是全世界唯一连着坐了 24 位皇帝的地方——别的宫殿都因改朝换代断了线，紫禁城连着走了 600 年。\n\n太和殿前丹陛石上一条云龙从下往上攀——整块汉白玉长【16.57 米】、重【200 余吨】，【1420】年冬天工匠用千匹骡子在泼水冻成的冰道上拖了【28】天，从房山滑到紫禁城。地面铺苏州烧的「金砖」，每块【108 斤】，烧制需【两年】，敲起来有金玉之声。殿内宝座下的地砖被六百年皇帝的脚磨得发乌，光从隔扇透进来，灰尘在朱红柱影里浮。\n\n【1420】年欧洲正陷黑死病第四波，布鲁内莱斯基在佛罗伦萨用飞扶壁撑石头——紫禁城用榫卯咬木材，两套对抗地心引力的方案隔着九千公里并行推进。', relatedFigure: [{ name: '蒯祥', era: '明', role: '御用工匠 · 紫禁城总设计师', link: '每一根主梁上都有他画的尺寸，《明实录》叫他「蒯鲁班」——皇帝只是签名的人' }], yearNum: 1420, wiki: 'Hall of Supreme Harmony', gradient: 'linear-gradient(135deg, #8B1A1A 0%, #C9963A 50%, #2D1B00 100%)', desc: '紫禁城是明清两朝的皇家宫殿，南北长960米，东西宽753米，共有房屋九千余间，是世界上现存规模最大、保存最完整的木质结构古建筑群。', hours: '淡季 08:30—17:00；旺季 08:30—17:30，周一闭馆', ticket: {
  ...
  { category: 'secret', text: '珍宝馆往深处走有珍妃井旁的皇家澡堂遗址，90% 游客看完大殿就走错过了' }
      ...
      { name: '长城（八达岭段）', era: '秦·公元前214年', hookShort: '每块砖印着工匠姓名——比 ISO 早 22 个世纪的追溯制。', whyVisit: '{tag: 秦·前 214 年｜工匠姓名制}\n\n每块砖上印着工匠姓名——比 ISO 早 22 个世纪的追溯制。烧坏了追到人，修不牢杀到家，质量不是「标准」，是命。\n\n北八楼的垛口高【1.7 米】，比守军平均身高高一头——射击孔开在胸前，人贴墙就是全身掩体。每块青砖长【37】厘米、重【12】公斤，烧制时印着工匠和州县姓名，这套追溯制度比明代早【1600 年】就在秦朝用过。八达岭这段是明代重修，砖缝的糯米石灰浆比现代水泥更耐冻；日落前半小时登北十二楼，光掠过墙脊，山脊线像一条等高线打印出来的黑刃。\n\n前【214】年蒙恬修第一版那年，亚历山大死后【109】年，他在巴克特里亚留下的希腊化王国刚开始铸佛像——东方用夯土断路，西方用石雕融合。', relatedFigure: [{ name: '戚继光', era: '明', role: '将军 · 修长城的人（不是秦始皇）', link: '八达岭这段是他督造的；他留下的《练兵实纪》今天仍在军校里被读' }], yearNum: -214, wiki: 'Great Wall of China', wikiImage: 'https://commons.wikimedia.org/wiki/Special:FilePath/The_Great_Wall_of_China_at_Jinshanling.jpg?width=1600', gradient: 'linear-gradient(135deg, #3D5A3E 0%, #8aad96 50%, #1a2d22 100%)', desc: '万里长城始建于春秋战国，总长度超过21,000公里，是人类历史上最伟大的建筑工程之一。', hours: '旺季 07:30—18:00；淡季 08:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '祈年殿西侧 30 米白石栏杆处可以把三层琉璃瓦攒尖顶整个框进镜头，正南拍只能拍到圆殿半边' // ✓ 锚点：具体方向西侧 30 米 + 只有去过才知道
      ...
      { name: '颐和园', era: '清·1750年', hookShort: '长廊 14000 幅彩画没有一幅重复，是明清文学史的屋檐。', whyVisit: '长廊 728 米，绘有彩画 14000 幅，没有任何两幅重复——内容从《三国》《西游》到花鸟虫鱼，等于把整个明清文学史贴在了昆明湖边的屋檐下。1750 年乾隆为母亲钮祜禄氏祝寿建清漪园那年，狄德罗刚在编《百科全书》第一卷——东方用园林浓缩天下山川，西方用词条切碎知识。十七孔桥的石狮共 544 只，每次游人数都数不清，因为大狮子背上、胸前、爪下还藏着小狮子。1900 年八国联军进京时颐和园被抢了 34 天，铜麒麟肚子上至今还留着俄军刺刀划的"1900"字样。', yearNum: 1750, wiki: 'Summer Palace', wikiImage: 'https://commons.wikimedia.org/wiki/Special:FilePath/Summer_Palace_in_Beijing_10.jpg?width=1600', gradient: 'linear-gradient(135deg, #2D6A4F 0%, #74C69D 50%, #1B4332 100%)', desc: '颐和园占地约290万平方米，万寿山与昆明湖相映，长廊、佛香阁、十七孔桥构成中国皇家园林最后的绝唱。', hours: '旺季 06:30—18:00；淡季 07:00—17:00', ticket: {
  ...
  },
  {
    ...
    timeline: [
      ...
      { year: '80 年', event: '斗兽场落成', desc: '科洛塞姆竣工，可容纳5万至8万观众。', epochTail: '到今天仍有 4 万块原石——但 2025 年欧盟议会辩论是否应该把 19 世纪从斗兽场搬到梵蒂冈的 200 块大理石归还原址' },
    ...
    landmarks: [
      { name: '科洛塞姆（斗兽场）', era: '公元72—80年', hookShort: '五万人十五分钟清场——现代体育场也没拉开多少。', whyVisit: '{tag: 罗马·公元 80 年｜5 万人清场 15 分钟}\n\n第一排观众离第一滴血只有【4 米】。大理石坐席按等级从下往上排开，皇帝席与地面持平，女眷与奴隶被推到顶层第【5】环——一座石头堆成的帝国切片。【80】座出口的编号至今还刻在拱门楣上。\n\n工程师测算过：【5 万人 15 分钟】清场——这速度现代体育场也没拉开多少。风从废掉的地板缝漏上来，你站的位置当年是活门，下面是豹子和角斗士共用的等候间。\n\n公元【80】年落成那年，洛阳的东汉白马寺刚迎来第一批天竺僧人——两座城同在为「看什么」建房子，一边看殉道，一边看搏杀。', relatedLiterature: [{ title: '《沉思录》', author: '马可·奥勒留', year: 180, quote: '我们生而为人，在这座城的石头上死去', link: '他是最后一位写哲学的皇帝，斗兽场是他拒绝参与的奢华' }], yearNum: 80, wiki: 'Colosseum', gradient: 'linear-gradient(135deg, #5C3317 0%, #C9963A 50%, #2A1500 100%)', desc: '科洛塞姆是罗马帝国修建的椭圆形竞技场，长轴188米、高约50米，其拱券结构深刻影响了西方建筑两千年。', hours: '09:00—19:00（夏季延至20:00）', ticket: {
  ...
  { category: 'secret', text: '加购 Arena Floor + Underground（+€9）能走角斗士通道，90% 游客不知道这个入口' }
      ...
      { name: '万神殿（Pantheon）', era: '公元125年', hookShort: '顶上开着一个九米的圆洞，雨直接落进来。', whyVisit: '抬头，穹顶正中是一个直径九米的圆洞，雨会直接落进来。地面微微下凹，排水孔至今在用。布鲁内莱斯基 1420 年为佛罗伦萨造穹顶那年，带着他的工匠来这里躺了三天——他想不明白一个一千三百年前的混凝土穹顶是怎么立住的，直到他发现顶部骨料换成了浮石，越往上越轻。125 年哈德良落成这栋建筑时，汉顺帝在洛阳铸造张衡的候风地动仪——一东一西，人类都在试探天的边界。现在它的功能是教堂，拉斐尔的墓在左侧第二个壁龛，没有标识牌，只有鲜花。', relatedFigure: [{ name: '拉斐尔', era: '1483-1520', role: '画家（不是皇帝）', link: '他的墓在这里——按他生前愿望葬在万神殿圆顶之下，没有标识牌，只有鲜花' }], yearNum: 125, wiki: 'Pantheon, Rome', gradient: 'linear-gradient(135deg, #4A3728 0%, #D4A96A 50%, #1E150D 100%)', desc: '万神殿圆顶直径43.3米，此后1300年无人超越。穹顶以火山灰混凝土浇筑，无一支柱。', hours: '09:00—19:00', ticket: {
  ...
  },
  {
    ...
    text: '万神殿距离纳沃纳广场步行 4 分钟、许愿池 8 分钟，半天可串联，穿软底鞋——鹅卵石硬' // ✓ 锚点：数字 4 / 8 分钟 + 只有去过才知道（鹅卵石硬）
      ...
      { name: '梵蒂冈圣彼得大教堂', era: '1506—1626年', hookShort: '华盖的青铜，是把异教神殿的屋顶熔了浇的。', whyVisit: '贝尼尼的铜华盖立在祭坛上，四根扭曲的螺旋柱铸自万神殿廊下拆来的青铜——罗马教会把一座异教神殿的屋顶熔了，浇成天主教最重要的覆盖物。穹顶是米开朗基罗七十二岁接下的活，他没见到封顶，死的时候鼓墙刚砌到一半。1626 年大教堂竣工这年，明熹宗天启六年，魏忠贤在北京毁了全国八百座东林书院——一边在筑穹，一边在拆梁。广场上 284 根科林斯柱围成椭圆，贝尼尼说这是"教会向世界张开的双臂"——从正门走到方尖碑要七十秒，这七十秒是全世界天主教徒一生至少要走一次的距离。', yearNum: 1626, wiki: "St. Peter's Basilica", gradient: 'linear-gradient(135deg, #1A1A4A 0%, #6A7FBF 50%, #0D0D2A 100%)', desc: '圣彼得大教堂是天主教世界最神圣的教堂，米开朗基罗设计的穹顶高达136米。', hours: '教堂 07:00—19:00；穹顶 08:00—18:00', ticket: {
  ...
  },
  {
    ...
    text: '从 Via della Conciliazione 大街东端看穹顶最对称；登顶后西北角栏杆是俯瞰广场的黄金位，避开正面挤 20 人' // ✓ 锚点：具体名字 Via della Conciliazione + 具体方向西北角
      ...
      { name: '古罗马广场', era: '公元前7世纪起', hookShort: '石板上的车辙是衰亡后一千年里牧羊人踩出来的。', whyVisit: '站在 Via Sacra 青石板上往西看，八根柱子是农神庙，公元前 497 年奉献——比孔子出生还早。再往东三十米是维斯塔贞女之家的回廊基座，六个处女守着一团火，火灭就处死。恺撒被刺那天（公元前 44 年 3 月 15 日）倒在庞培剧场门廊下，血滴就是沿这条石板路被抬到火葬台；当年东方，汉武帝死去已 43 年，司马迁的《史记》刚成书十年。脚下这条石板被两千年的马蹄磨出车辙，深处能积水——这不是浪漫，是罗马衰亡后一千年里，牧羊人每天赶牛从议事堂穿过留下的。现在傍晚六点关门前，光从提图斯凯旋门的空洞斜穿过来，正好落在恺撒神殿残基上。', yearNum: -600, wiki: 'Roman Forum', gradient: 'linear-gradient(135deg, #6B4C11 0%, #C9963A 45%, #3D2800 100%)', desc: '古罗马广场是共和国与帝国时代的政治、宗教和商业中心。', hours: '09:00—日落前1小时', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '圣索菲亚大教堂', era: '拜占庭·537年', hookShort: '做过一千年教堂，五百年清真寺，现在在做第三件事。', whyVisit: '{tag: 拜占庭·537 年｜穹顶 31 米·三教叠加}\n\n抬头看穹顶基座，一圈【40】扇小窗连成光环，让【31 米】直径的穹顶看起来像悬浮半空——查士丁尼的工匠砌到一半塌了两次，第三次才学会让骨料换成更轻的罗德岛浮岩。【537】年落成，做过【1000 年】东正教堂，做过【500 年】清真寺，【2020】年又回到清真寺。\n\n【1453】年穆罕默德二世进城后命工匠用薄石膏把圣母像盖上，【900 年】没拆——【1935】年石膏剥落时圣母的金色眼睛从下面看出来，和麦加方向的金光叠在同一个画面里。非礼拜时段进去，地毯铺在原来的大理石马赛克上，脚下的层是可以踩出来的。\n\n【537】年落成那年，南梁武帝在同泰寺舍身出家第三次——东西两端的皇帝都在用宗教给权力盖章，一个盖在石头上，一个跪在蒲团上。', relatedFigure: [{ name: '安特米奥斯', era: '东罗马', role: '建筑师（不是查士丁尼）', link: '穹顶的几何是他和伊西多尔算出来的，皇帝只是付钱的人' }], yearNum: 537, wiki: 'Hagia Sophia', gradient: 'linear-gradient(135deg, #4A2C0A 0%, #D4841A 45%, #C9963A 100%)', desc: '圣索菲亚是拜占庭建筑的顶峰之作，近千年来一直是世界上最大的教堂。', hours: '礼拜时间外开放 09:00—17:30', ticket: {
  ...
  { category: 'secret', text: '二楼楼梯口大理石栏杆上刻着 Halvdan 的北欧海盗涂鸦（9 世纪），在西南角人容易错过' }
      ...
      { name: '蓝色清真寺', era: '奥斯曼·1616年', hookShort: '那片蓝，是矢车菊花瓣烧出来的钴料。', whyVisit: '内墙嵌 21043 块伊兹尼克瓷砖，蓝色是从矢车菊花瓣烧出来的钴料，触感凉润，不是现代化工颜料的亮蓝。六座宣礼塔在当时是违制——整个伊斯兰世界只有麦加大清真寺配六塔，年轻苏丹艾哈迈德一世只好出钱给麦加加盖第七塔平息非议。1616 年清真寺落成那年，莎士比亚在伦敦去世——这一边的权力正把戏剧做成石头。内部四根主柱被伊斯坦布尔人叫作"大象腿"，直径 5 米；礼拜时跪垫呈斜角铺向麦加方向，不与墙平行，走进去会有一瞬间晕。日落宣礼从六塔同时响起，蓝色从瓷砖里渗出来爬上穹顶。', relatedLiterature: [{ title: '《伊斯坦布尔：一座城市的记忆》', author: '奥尔罕·帕慕克', year: 2003, quote: '忧愁是这座城市的底色', link: '他写自己从小在蓝色清真寺对面长大，穹顶是他童年的天花板' }], yearNum: 1616, wiki: 'Sultan Ahmed Mosque', gradient: 'linear-gradient(135deg, #0A2A4A 0%, #1A6B9A 50%, #0D3D6B 100%)', desc: '因内部2万余块伊兹尼克蓝色瓷砖得名，六座宣礼塔至今仍是活跃的礼拜场所。', hours: '日出—日落，礼拜期间关闭', ticket: {
  ...
  },
  {
    ...
    text: '与圣索菲亚隔广场相望步行 3 分钟，建议上午圣索菲亚 + 下午蓝色清真寺，两者光线方向相反' // ✓ 锚点：数字 3 分钟 + 只有去过才知道
      ...
      { name: '托普卡帕宫', era: '奥斯曼·1465年', hookShort: '苏丹 5000 人的羊和米，从十个烟囱下出锅。', whyVisit: '第二庭院"御膳房"十个烟囱至今能认出来——苏丹及其 5000 人后宫每天的羊和米从这里出锅，1572 年起由米马尔·希南亲自翻修。帝国征服了就往上加一个庭院，四个庭院一层层嵌套向海；1465 年穆罕默德二世建第一院时，佛罗伦萨的乌菲兹还没成气候——东西两头都在用建筑定义权力的内与外。后宫 400 多间房几乎都不开窗，墙上贴绿松石瓷砖的房间是"苏丹太后"专用，她是帝国真正的操盘手。珍宝库里的图普卡帕匕首镶 3 颗祖母绿，007 电影都抄过它；而苏莱曼的金箭袋放在角落玻璃柜里，木料已经酥。', yearNum: 1465, wiki: 'Topkapı Palace', gradient: 'linear-gradient(135deg, #2A1A0A 0%, #8B6914 50%, #4A3010 100%)', desc: '奥斯曼帝国苏丹的官邸，历时400余年持续扩建，占地约70万平方米。', hours: '09:00—18:45（夏季），周二闭馆', ticket: {
  ...
  },
  {
    ...
    text: '闭馆日是周二；旺季一日五票型全要 €55 通票，淡季选主宫 + 后宫 €49 即可' // ✓ 锚点：数字 €55/€49 + 具体时间周二
      ...
      { name: '大巴扎', era: '奥斯曼·1461年', hookShort: '1461 年开市第一天烫杯子的红茶，今早还在烫。', whyVisit: '61 条街，4000 间店，1461 年建时是帝国的中央银行——"货币兑换街"至今还在原址，1460 年代的石拱卷依然承重。金饰区 Kalpakçılar 街的地砖油光比其他街亮一号，因为六百年金箔师傅用脚踢石屑的角度都一样。每天清晨 8 点半，店主会用红茶烫杯子，这个动作和 1461 年开市第一天没有区别。同一时期大明成化年间，北京东安门外的鲜鱼巷也在摆摊——不同的是那些摊两百年就没了，大巴扎一直开着。想找最便宜的番红花要走到古书街尽头再右拐；想看真古董得爬一段石阶进 Cevahir Bedesten，门楣上还挂着奥斯曼皇家徽章。', yearNum: 1461, wiki: 'Grand Bazaar, Istanbul', gradient: 'linear-gradient(135deg, #4A0A0A 0%, #C94A1A 50%, #2A0A00 100%)', desc: '世界上最古老、最大的有顶集市之一，60余条街道、4000余间店铺。', hours: '周一至周六 08:30—19:00，周日闭馆', ticket: {
  ...
  },
  {
    ...
    text: '山路湿滑 + 夜间无护栏，下雨天和冬季雪后非常滑；登山鞋或防滑底鞋比运动鞋安全' // ✓ 锚点：只有去过才知道 + 具体时间冬季
      ...
      { name: '金阁寺（鹿苑寺）', era: '室町·1397年', hookShort: '足利义满把日本三种权力堆成一栋楼，贴金罩起来。', whyVisit: '{tag: 室町·1397 年｜贴金 20 公斤}\n\n禅宗美学里最罕见的「我想让全世界都看见」——足利义满把一栋楼包上金箔，不是为了修行，是为了示威：武士家族第一次登上文化权力的顶端。\n\n三层楼每层建筑样式不同：一层寝殿造（平安贵族）、二层武家造（武士）、三层禅宗佛殿——义满把【1397】年以前日本三种权力形态堆成一栋楼，贴金箔【20 公斤】罩起来。【1950】年一个精神不稳的年轻僧人纵火把它烧了（三岛由纪夫为此写了一本长篇）；现在外层金箔厚【0.45 微米】，比【1955】年重建时还厚五倍。镜湖池对岸看过去，上午【10 点到 11 点】湖面无风，金阁与倒影成垂直对称，那半小时是全日本被拍得最多的半小时。\n\n同期欧洲乔托已死【60 年】，意大利进锡耶纳派后期——一边在墙上画金色圣像，一边在湖面贴金色。', relatedLiterature: [{ title: '《金阁寺》', author: '三岛由纪夫', year: 1956, quote: '美在被毁灭的瞬间才达到顶点', link: '1950 年纵火的年轻僧人，就是小说的主人公原型' }], yearNum: 1397, wiki: 'Kinkaku-ji', gradient: 'linear-gradient(135deg, #1A3A1A 0%, #C9963A 45%, #0D2010 100%)', desc: '足利义满建造，三层阁楼以金箔贴覆，倒映于镜湖池中。1950年被纵火焚毁，1955年重建。', hours: '09:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '11 月下旬红叶季最佳，镜湖池畔枫树倒影能和金阁一起入画；5 月初新绿的青金阁同样稀有' // ✓ 锚点：具体时间 11 月下旬 / 5 月初 + 只有去过才知道
      ...
      { name: '二条城', era: '江户·1603年', hookShort: '264 年前开房子的人，关房子时坐同一片地板。', whyVisit: '二之丸御殿的走廊叫"莺张"——每根地板下藏一根金属片叫"目钉"，踩上去发出像黄莺鸣叫的颤音，任何忍者夜入都会被暴露。1603 年德川家康建此城那年，莎士比亚《哈姆雷特》首次上演——东方的幕府在用建筑防暗杀，西方的剧场在演暗杀。大广间里狩野派屏风画金箔松树遒劲伸展，是向前来觐见的大名无言宣告"这座国家现在姓德川"。1867 年 10 月 14 日，第十五代将军德川庆喜就在这同一间大广间里向明治天皇宣布"大政奉还"——264 年前开房子的人和关房子的人，坐的是同一地板、看的是同一松树。外护城河里的锦鲤据说是 19 世纪末养的最后一批，红白颜色延续了四代。', yearNum: 1603, wiki: 'Nijo Castle', gradient: 'linear-gradient(135deg, #1A2A3A 0%, #4A7A9B 50%, #0D1A26 100%)', desc: '德川家康建造，以“莺张地板”著称。1867年末代将军在此宣布大政奉还。', hours: '08:45—16:00', ticket: {
  ...
  },
  {
    ...
    text: '本丸御殿庭园从东北角度望樱花与天守台石垣同框，是城内不为人知的机位' // ✓ 锚点：具体方向东北 + 具体名字本丸御殿 + 只有去过才知道
      ...
      { name: '清水寺', era: '平安·778年', hookShort: '悬崖舞台 139 根欅木柱撑出，没用一颗铁钉。', whyVisit: '{tag: 平安·778 年｜139 根柱零铁钉}\n\n「从清水舞台跳下」是日语成语——江户时代有 234 人真跳过，活下来 85%。一座寺院变成母语里的隐喻，靠的不是建筑，是一次又一次决断的回声。\n\n本堂建在悬崖上，前台舞台由【139】根欅木柱子撑出，离崖底【13 米】，没用一颗铁钉——榫卯咬合处至今看不见任何腐朽，上一次大修【2017-2020 年】换了【35 万片】桧木瓦。音羽瀑布三股泉水分别代表学业、爱情、长寿，日本高中生会选一股喝——三股都喝反而失效，这个规矩【600 年】没变。秋天枫红满山时舞台像架在一张烧红的网上。\n\n【778】年僧侣延镇建庵时，唐玄宗已驾崩【16】年——清水寺接收了所有从长安流传过来的佛塔形制，却转头发展出「舞台」这个完全日本的形。', relatedLiterature: [{ title: '《枕草子》', author: '清少纳言', year: 1002, quote: '春は、あけぼの', link: '她写清水寺春日「日光从山上滚下来」的那段被写进日本初中课本' }], yearNum: 778, wiki: 'Kiyomizu-dera', gradient: 'linear-gradient(135deg, #3A1A2A 0%, #8B4A6B 50%, #1A0D15 100%)', desc: '建于悬崖之上，本堂前舞台以139根木柱支撑，不用一颗钉子。', hours: '06:00—18:00', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '吉萨大金字塔群', era: '古王国·约前2560年', hookShort: '底边四角误差不超 5 厘米——只靠日影和水面。', whyVisit: '{tag: 古王国·约前 2560 年｜230 万块石灰岩}\n\n胡夫金字塔由约【230 万】块石灰岩砌成，底部四个边长误差不超过【5 厘米】——现代 GPS 才能达到的精度，公元前【2560】年的工匠只凭日影和水面校准就做到了。从北面盗墓者通道钻进去，爬到国王墓室要【60 米】，空气里是【4500 年】的花岗石粉尘。\n\n金字塔原本外覆一层白色图拉石灰岩，抛光到能反光——阿拉伯人陆续剥去建开罗的清真寺，现在顶部还能看到一小块残存，日落时那块会亮得刺眼。狮身人面像的鼻子不是被拿破仑的炮轰掉的，是【14 世纪】一位苏菲派修士用锤子砸的——砸的原因是当地人还在偷偷拜它。\n\n同时期的东方还在夏朝建立前约【450】年，黄河流域的龙山文化刚开始烧制黑陶——一边用石头抵抗遗忘，一边用陶土装纳饮食。', relatedFigure: [{ name: '希缪努 Hemiunu', era: '前 2570', role: '工程师 · 法老胡夫的侄子兼总设计师', link: '他的雕像是人类史上第一个被署名的建筑师' }], yearNum: -2560, wiki: 'Giza pyramid complex', gradient: 'linear-gradient(135deg, #4A3A1A 0%, #C9963A 45%, #8B6914 100%)', desc: '古代世界七大奇迹中唯一留存至今。胡夫金字塔使用约230万块石块，四个底边误差不超过5厘米。', hours: '08:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '大金字塔内部通道 45° 上升 + 1.2 米低矮 + 无空调，50℃ 体感 + 封闭空间，幽闭症和膝盖不好者不要买内部票' // ✓ 锚点：数字 45°/1.2 米/50℃ + 只有去过才知道
      ...
      { name: '埃及博物馆', era: '近代·1902年', hookShort: '十一位法老并排——你能数出他们的睫毛。', whyVisit: '图坦卡蒙黄金面具重 11 公斤，纯金嵌青金石、红玉髓、琉璃——1922 年卡特在国王谷打开第 62 号墓那天，面具刻的是一个 19 岁少年的脸（他 9 岁继位、18 岁死去）。同年中国民国推翻袁世凯已六年，安阳殷墟还要再等六年才开挖——东西两端都在从土里翻过去。馆内 16 万件文物只有 1/3 展出，二层木乃伊厅十一位法老并排：拉美西斯二世（颅骨上还有几根红发）、图特摩斯三世、塞提一世——公元前 13 世纪的人脸，你能数出他们的睫毛。1902 年的红砖建筑本身也快要进博物馆——2025 年后大部分藏品将迁至大埃及博物馆，届时你在这里看到的是百年殖民遗产的最后一季。', yearNum: 1902, wiki: 'Egyptian Museum', gradient: 'linear-gradient(135deg, #1A1A3A 0%, #6A4A8B 50%, #0D0D1E 100%)', desc: '收藏文物逾17万件，镇馆之宝包括图坦卡蒙法老的黄金面具。', hours: '09:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '闭馆日无固定（与埃及伊斯兰节日挂钩），出发前一天官网查；斋月期间闭馆早 1 小时' // ✓ 锚点：数字 1 小时 + 只有去过才知道
      ...
      { name: '爱资哈尔清真寺', era: '法蒂玛·970年', hookShort: '975 年开课，比牛津早 121 年——至今未停学。', whyVisit: '建于法蒂玛王朝 970 年，附设的爱资哈尔大学 975 年开课——比牛津（1096）早 121 年，比巴黎大学（1150）早 175 年，是人类历史上持续运作时间最长的高等学府。中庭大理石柱每根风格不同：工匠从周边罗马和拜占庭废墟搬来旧柱重用——罗马科林斯式、拜占庭十字花式、甚至个别雕着十字架（被石膏抹掉一半）——这座清真寺是地中海文明层的 X 光片。同期宋太祖赵匡胤 960 年刚黄袍加身，开封正规划大相国寺——两座城都在用宗教建筑缝合新政权的合法性。每天午后在庭院里能看到几百个学生席地而坐背诵古兰经，摇晃的节奏千年没变。', yearNum: 970, wiki: 'Al-Azhar Mosque', gradient: 'linear-gradient(135deg, #0A2A1A 0%, #1A6B4A 50%, #0D3D26 100%)', desc: '附属大学建于975年，是世界上最古老的持续运作的大学之一。', hours: '09:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '爱资哈尔清真寺北门的 Bab al-Muzayyinīn 大门夜间灯光照射下金色雕花最美，市集入口拱门也是开罗邮卡经典机位' // ✓ 锚点：具体名字 Bab al-Muzayyinīn + 具体方向北门
      ...
      { name: '萨拉丁城堡', era: '阿尤布·1183年', hookShort: '城墙上的白石板，是从吉萨金字塔外层拆来的。', whyVisit: '萨拉丁 1176 年下令动工对抗十字军，建在穆卡塔姆山丘顶端——石料部分拆自吉萨金字塔外层，现在城墙上能找到比基辛家具橱柜还齐整的白色图拉石板。1250 年马穆鲁克王朝在此崛起，奴隶出身的突厥士兵杀主篡位管了埃及 267 年；同期路易九世第七次十字军在尼罗河三角洲被俘，赎金 40 万第纳尔恰好相当于法国一年税收。1830 年代穆罕默德·阿里在这里宴请 470 名马穆鲁克贝伊——宴毕下令关闭城门、窄道上全部屠杀；只有一人骑马跳下 20 米城墙逃生，马摔死、人活了。清真寺穹顶白色大理石从亚历山大港拆来的古罗马浴场柱，阳光下能看到石头上残存的罗马凿痕。', yearNum: 1183, wiki: 'Cairo Citadel', gradient: 'linear-gradient(135deg, #2A2A1A 0%, #6B6B2A 50%, #1A1A0A 100%)', desc: '位于穆卡塔姆山丘顶端，俯瞰整个开罗城。', hours: '08:00—17:00', ticket: {
  ...
  // ─── P1 CITIES ───────────────────────
  {
    ...
    landmarks: [
      { name: '巴黎圣母院', era: '中世纪·1163年', hookShort: '1500 尊石像，都是匿名石匠按邻居的脸刻的。', whyVisit: '{tag: 中世纪·1163 年｜1500 尊石像}\n\n西立面三座大门雕刻共【1500】多个人像，每一尊都是中世纪匿名石匠按邻居脸刻的——所谓「石头上的《圣经》」是给不识字者看的漫画书。飞扶壁是哥特式最激进的发明：外墙被掏空塞满玫瑰花窗，压力全由外侧几十条拱形石梁接住，让彩色玻璃在【12 世纪】屋顶下合法存在。\n\n【2019】年【4】月【15】日 18:43 火从屋顶阁楼铅皮下燃起，【900 年】橡木屋架——「森林」，每根梁来自一棵单独的橡树——一夜烧尽。消防员在【21:45】保住双塔，钟声响起时整个西岱岛街道跪满人；修复用的是从法国各地重新砍伐的【2000】棵橡树，工艺按中世纪图纸复刻。\n\n【1163】年动工时，南宋刚建立【36】年、岳飞冤死【21】年——东方用《资治通鉴》把历史记下来，西方用石头把信仰刻下来。', yearNum: 1163, wiki: 'Notre-Dame de Paris', gradient: 'linear-gradient(135deg, #2A2A3A 0%, #6A6A8B 50%, #1A1A2A 100%)', desc: '哥特式建筑的杰作，飞扶壁和玫瑰花窗是中世纪工程与艺术的巅峰。2019年大火后正在修复中。', hours: '修复中，部分区域开放', ticket: {
  ...
  },
  {
    ...
    text: '作为活跃教堂，进入不可暴露——短裤短裙会被拦；玫瑰花窗光线从南向北照进，上午最绚丽' // ✓ 锚点：具体方向南向北 + 只有去过才知道
      ...
      { name: '埃菲尔铁塔', era: '近代·1889年', hookShort: '打破了金字塔保持四千年的"最高"纪录。', whyVisit: '塔高 324 米（含天线）——是人类历史上第一座超过 200 米的建筑物，打破了吉萨大金字塔保持了 4000 年的纪录。埃菲尔用 18038 根熟铁件、250 万颗铆钉在两年两个月内组装完成，每根铆钉都由四人一组现场锻打。同年东方是光绪十五年，颐和园刚建完，慈禧太后正挪用北洋水师军费；六年后甲午战争让这座花园显得荒唐。铁塔原计划 1909 年拆除，埃菲尔本人把塔顶改成无线电实验站救下它——1916 年法军从这里截获德军加密电文，导致女间谍玛塔·哈里被捕。今天塔身每七年涂一遍漆，60 吨一次，由 25 名高空画匠手刷——机器没法进铆钉缝。', yearNum: 1889, wiki: 'Eiffel Tower', gradient: 'linear-gradient(135deg, #3A3A4A 0%, #8A8A9B 50%, #1A1A2A 100%)', desc: '高324米，建造时使用了7300吨铁和250万颗铆钉。原计划20年后拆除，因无线电天线的价值而得以保留。', hours: '09:30—23:45', ticket: {
  ...
  },
  {
    ...
    text: '铁塔在塞纳河风口，顶层比地面冷 5-8℃；冬季 1-2 月顶层体感 -5℃ 以下，带厚围巾和手套' // ✓ 锚点：数字 5-8℃ / -5℃ + 具体时间 1-2 月
      ...
      { name: '卢浮宫', era: '12世纪—1793年', hookShort: '蒙娜丽莎只有 77×53 厘米——比多数人预想的小一半。', whyVisit: '《蒙娜丽莎》只有 77×53 厘米——比大多数人预想的小一半——挂在德农馆 711 号厅防弹玻璃后面。达芬奇 1503 年开始画，一直带在身边到 1519 年在法国去世；François 一世花 4000 金埃居买下时，她还是王室私人收藏。1911 年一个意大利工人把她从墙上摘下藏进大衣，在卢浮宫丢了两年——他想敲勒索金。此事让她一夜成名之前，她只是普通文艺复兴画。同年清末最后一个科举状元已过去七年，京师大学堂挂牌——东西两端都在以不同节奏告别旧权威。懂行的人走右手楼梯上二层，Sully 翼 346 厅《断臂维纳斯》早 9 点 15 分人极少。', yearNum: 1793, wiki: 'Louvre', gradient: 'linear-gradient(135deg, #2A1A0A 0%, #8B6914 50%, #4A3010 100%)', desc: '世界上参观人数最多的博物馆，收藏超过38万件作品，包括《蒙娜丽莎》和《断臂维纳斯》。', hours: '09:00—18:00，周二闭馆', ticket: {
  ...
  },
  {
    ...
    text: '入口避开金字塔主门（排队 30-60 分钟），选 Porte des Lions 南门或 Carrousel 地下入口，排队短 50%' // ✓ 锚点：具体名字 Porte des Lions / Carrousel + 数字 50%
      ...
      { name: '凡尔赛宫', era: '17世纪·1682年', hookShort: '17 世纪镜子是战略物资，威尼斯曾下令追杀偷师工匠。', whyVisit: '镜厅长 73 米，17 拱窗对应 17 面由 357 块威尼斯玻璃拼成的镜——17 世纪镜子是战略物资，路易十四派间谍从威尼斯偷师时威尼斯政府曾下令追杀这些工匠。1682 年迁宫那年，清康熙二十一年北京正准备收复台湾——东西两个帝国都在用空间的宏大压制权贵：凡尔赛把法国贵族圈养起来跳舞，避免他们在领地搞独立。花园 50 座喷泉靠 25 公里运河和 14 台"马利机器"水泵运行。1919 年 6 月 28 日《凡尔赛条约》就在镜厅签字——德国代表走进去时头顶 357 面镜子同时反射他们的签字笔，这是冷战之前对一个民族最后的仪式羞辱。', yearNum: 1682, wiki: 'Palace of Versailles', gradient: 'linear-gradient(135deg, #4A3A1A 0%, #C9963A 50%, #2A1A00 100%)', desc: '太阳王路易十四建造的宫殿，镜厅拥有357面镜子，花园面积达800公顷。', hours: '09:00—18:30，周一闭馆', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '帕特农神庙', era: '古典·前447年', hookShort: '希腊人已知：直柱显凸肚，向内倾反而显直。', whyVisit: '{tag: 古典·前 447 年｜46 根柱倾 7 厘米}\n\n柱子微微向内倾斜——每根朝中心倾约【7 厘米】，如果把【46】根立柱向上延伸【2.4 公里】，它们会交汇到天空中一点。这不是装饰，是「视觉修正」：人眼看直柱显凸肚，向内倾反而显直——公元前【447】年的希腊人已懂视知觉。\n\n雕带原有【115 米】浮雕「泛雅典节游行」，【1801】年英国大使埃尔金伯爵强拆【75 米】运回伦敦，至今在大英博物馆二层——希腊政府追讨了【200 年】，雅典卫城博物馆底楼特意留了一面空墙等它回来。神庙内曾立【12 米】高的雅典娜金象牙像，【1200 公斤】黄金，拜占庭时期被拆，一半金子做了君士坦丁堡的王冠。\n\n同期东方春秋末战国初，范蠡辅助越王勾践灭吴——东西两端都在打造「城邦对城邦」的世界格局，一个靠哲学辩论，一个靠卧薪尝胆。', relatedFigure: [{ name: '菲迪亚斯', era: '前 5 世纪', role: '雕塑家', link: '帕特农的雅典娜雕像是他做的，传说他在盾牌边缘偷偷刻了自己的像被判亵渎' }], yearNum: -447, wiki: 'Parthenon', gradient: 'linear-gradient(135deg, #4A3A2A 0%, #C9A96A 50%, #2A1A0A 100%)', desc: '供奉雅典娜女神的神庙，多立克柱式的完美典范。柱子微微向内倾斜以修正视觉错觉，精确度令现代建筑师惊叹。', hours: '08:00—20:00（夏季）', ticket: {
  ...
  },
  {
    ...
    text: '卫城博物馆 €15 是与帕特农成对的必修课，展厅透明玻璃让雕像正对原神庙方向，仪式感满' // ✓ 锚点：数字 €15 + 只有去过才知道
      ...
      { name: '雅典卫城', era: '青铜时代起', hookShort: '一颗炮弹击中弹药库，最完整的希腊建筑成了废墟。', whyVisit: '海拔 156 米的石灰岩台地是天然要塞——1687 年威尼斯人炮轰时一颗炮弹击中土耳其人用帕特农当弹药库的那部分，把一千两百年来最完整的希腊建筑炸成了废墟。上到山门走"神圣之路"石阶，被两千五百年的脚磨出光面——无盲道、无扶手、下雨极滑，故意保留的"不便利"。伊瑞克提翁神庙南端六尊少女柱原件五尊在卫城博物馆，现场是复制品，颈部裂纹清晰可见。公元前 5 世纪伯里克利的"黄金时代"，苏格拉底在山脚下辩论——同期孔子死后 50 年，七十二弟子正把老师语录整理成《论语》。东西两端同时诞生了哲学与礼学，中间隔着一整片欧亚草原。', yearNum: -500, wiki: 'Acropolis of Athens', gradient: 'linear-gradient(135deg, #3A2A1A 0%, #8B7A5A 50%, #1A0D00 100%)', desc: '卫城是一座天然要塞，海拔156米的石灰岩山丘上汇集了帕特农神庙、伊瑞克提翁神庙等建筑群。', hours: '08:00—20:00', ticket: {
  ...
  },
  {
    ...
    text: '每月首个周日（11-3 月）、3/6、5/18、10/28 免费但必须提前网上预约时段；免费日往往比付费日更挤' // ✓ 锚点：具体时间每月首个周日 / 3-6 / 5-18 / 10-28 + 只有去过才知道
      ...
      { name: '古代市集（Agora）', era: '古典·前6世纪', hookShort: '苏格拉底从这条石板路被押去饮鸩。', whyVisit: '阿塔罗斯柱廊 1952-56 年由美国考古学院完全重建，是世上唯一能让你走进去感受公元前 2 世纪购物中心的复原建筑——116 米长，16 间店铺，柱子多立克与爱奥尼亚混用。柱廊前的石板路上，苏格拉底在前 399 年接受审判后从这里被押走去饮下鸩酒。东方同一时期，吴起被楚国贵族乱箭射死，商鞅变法还要再等 22 年——东西两端都在争论"法律是什么、谁该被处死"。赫菲斯托斯神庙在市集西侧山丘上，保存最完整的希腊神庙没有之一——因为 7 世纪起被改为东正教堂一直用到 1834 年，屋顶始终有人修。现在石阶缝里能看见乌龟爬出来。', yearNum: -500, wiki: 'Ancient Agora of Athens', gradient: 'linear-gradient(135deg, #2A2A1A 0%, #6B5A3A 50%, #1A1A0D 100%)', desc: '苏格拉底在此辩论，柏拉图在此漫步。阿塔罗斯柱廊已完整重建，是了解古希腊日常生活的最佳场所。', hours: '08:00—20:00', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '圣母百花大教堂', era: '文艺复兴·1436年', hookShort: '不用飞扶壁、不用木支架——他在万神殿躺了三天。', whyVisit: '{tag: 文艺复兴·1436 年｜穹顶 45.5 米}\n\n布鲁内莱斯基设计的穹顶【45.5 米】直径，不使用飞扶壁、不使用木质支架——他拿罗马万神殿当实物教材，悄悄在那里躺了【三天】，然后发明了「双层穹顶」结构和「鱼骨砖」铺法，让每一层砖都能支撑自己不塌。\n\n登顶【463】级狭窄石阶，中间一段必须侧身——这是刻意保留的挤压感，布鲁内莱斯基让你感受他那【16 年】如何一砖一砖把自己挤到天堂。外墙白、绿、粉【三色】大理石来自卡拉拉、普拉托、马雷马——托斯卡纳自己的地质切片。\n\n【1436】年封顶那年，明宣德元年刚过、郑和已辞世【1 年】——中国的远洋时代结束，西方的建筑革命才开始。', yearNum: 1436, wiki: 'Florence Cathedral', gradient: 'linear-gradient(135deg, #8B4A2A 0%, #D4841A 50%, #4A2A0A 100%)', desc: '布鲁内莱斯基设计的穹顶直径45米，不使用飞扶壁，至今仍是最大的砖砌穹顶。他甚至为此发明了新的建造机械。', hours: '10:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '教堂周日上午 10:30 弥撒，游客暂停入场 90 分钟；想听管风琴可坐下听一场，是最佳免费礼物' // ✓ 锚点：具体时间周日 10:30 + 数字 90 分钟 + 只有去过才知道
      ...
      { name: '乌菲兹美术馆', era: '16世纪·1581年', hookShort: '维纳斯脚下的金粉，500 年后仍在下午三点闪。', whyVisit: '波提切利《维纳斯的诞生》1485 年画在两张亚麻布拼成的画布上而非木板——欧洲第一批用画布的经典作品之一，让它更便携、更不怕开裂。维纳斯脚下的扇贝、头发上的花瓣都是波提切利用金粉勾过，500 年后金粉仍在下午 3 点的斜光里闪。隔壁《春》里墨丘利手指上方有一颗甜橙——美第奇家族的族徽；波提切利把整幅画签名成一张感谢函送给劳伦佐·美第奇。1485 年明成化末年，唐伯虎出生——东西两端都进入文人画巅峰，主题却相反：东方画山水不画人，西方把人画到神的位置。乌菲兹原是 1581 年美第奇的办公楼，"uffizi"在意大利语里就是 offices。', yearNum: 1581, wiki: 'Uffizi', gradient: 'linear-gradient(135deg, #1A2A3A 0%, #4A6A8B 50%, #0D1A2A 100%)', desc: '收藏了波提切利《维纳斯的诞生》、达芬奇《天使报喜》等文艺复兴巅峰之作。', hours: '08:15—18:30，周一闭馆', ticket: {
  ...
  },
  {
    ...
    text: '每月首个周日免费进馆但必须网上预约时段，席位 08:00 开放瞬空' // ✓ 锚点：具体时间每月首个周日 / 08:00 + 只有去过才知道
      ...
      { name: '老桥（Ponte Vecchio）', era: '中世纪·1345年', hookShort: '大公嫌肉味重，下令全桥改卖珠宝——430 年未变。', whyVisit: '1345 年建，阿诺河上唯一幸免于 1944 年德军炸桥的老桥——传说希特勒下令保留，据说是看过戈林战前度假照片自己也想来走一趟。桥上原是肉铺和皮革店，1593 年费迪南多一世觉得肉味太重，下令全部改为金匠店，开启了桥上珠宝业 430 年不变的传统。桥中央向北看，头顶是瓦萨里走廊——1565 年设计的 750 米密道，让美第奇大公不必与平民挤桥就能从旧宫走到碧提宫。同期明万历年间张居正刚变法——东西两端的权贵都在建绕开百姓的专用通道。桥面石板中间凹陷最深处约 3 厘米，就在瓦萨里走廊出口正下方——大公最爱走这里俯瞰阿诺河。', yearNum: 1345, wiki: 'Ponte Vecchio', gradient: 'linear-gradient(135deg, #4A3A1A 0%, #8B7A5A 50%, #2A1A0A 100%)', desc: '阿诺河上最古老的桥梁，桥上开满金银首饰店。二战中德军撤退时唯一未被炸毁的佛罗伦萨桥梁。', hours: '全天开放', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '秦始皇兵马俑', era: '秦·前210年', hookShort: '青铜剑覆铬盐膜，秦人比德国人早了 2200 年。', whyVisit: '{tag: 秦·前 210 年｜8000 陶俑无同脸}\n\n【8000】陶俑没有两张相同的脸——发髻、胡须、眉毛、表情、身材高矮都按真人复刻，考古学家【2010】年用三维比对发现俑脸与今陕西户县、蓝田当地人面部特征高度重合：就是秦军本人的戳样。每个俑原本都彩绘，出土【30 秒】内氧化褪色，现在看到的灰陶是保护色被剥掉之后的素胎。\n\n一号坑【230 米】长，步兵方阵前【三】排无铠甲——是死士。兵器坑出土的青铜剑剑身覆【10-15 微米】铬盐氧化膜，【20 世纪 30 年代】德国才申请到这项防锈专利——秦人早了【2200 年】。\n\n同期西方，罗马正进第二次布匿战争、汉尼拔刚越过阿尔卑斯山——东西两端的军事革命同时进行，一边埋进土里做静态保险，一边打在战场上做活体演练。', yearNum: -210, wiki: 'Terracotta Army', gradient: 'linear-gradient(135deg, #4A3A1A 0%, #8B7A5A 50%, #2A1A0A 100%)', desc: '1974年偶然发现的地下军团，约8000个真人大小的陶俑，每个面容各异。被誉为“世界第八大奇迹”。', hours: '08:30—18:00', ticket: {
  ...
  },
  {
    ...
    text: '展坑内温度常年 15-18℃（地下恒温），7-8 月夏季从 40℃ 室外进去会起鸡皮疙瘩；冬季反而更暖' // ✓ 锚点：数字 15-18℃/40℃ + 只有去过才知道
      ...
      { name: '西安城墙', era: '明·1370年', hookShort: '墙缝是糯米石灰浆——比 C30 混凝土还耐冻融。', whyVisit: '周长 13.74 公里，1370 年朱元璋命徐达在唐长安皇城基础上扩建，高 12 米、底宽 18 米、顶宽 15 米，上面能跑马车。墙体是夯土包青砖，夯土用糯米、石灰、黄土按 7:2:1 配比，砖缝灌糯米石灰浆——这套"古代水泥"比现代 C30 混凝土还耐冻融。每块墙砖重 20 公斤，每块上都有工匠和州县姓名——责任追溯制。1370 年是明洪武三年，同期朝鲜半岛高丽王朝刚灭，李成桂即将建立朝鲜；欧洲英法百年战争正打到第 33 年。登城墙最佳时段是傍晚骑车环绕一圈（约 2 小时），夕阳把每块砖的边缘镀成金边，永宁门外的灯笼从城楼檐下垂下，那一刻西安回到 1370 年。', yearNum: 1370, wiki: 'Fortifications of Xi\'an', gradient: 'linear-gradient(135deg, #3A2A1A 0%, #6B5A3A 50%, #1A0D00 100%)', desc: '中国现存最完整的古代城墙，周长13.74公里，可骑自行车环行一圈。', hours: '08:00—22:00', ticket: {
  ...
  },
  {
    ...
    text: '城墙顶风道冬季风力大比地面低 3-5℃，12 月骑行必须戴围巾面罩；夏季 6-8 月反而晒死人午间 40℃+' // ✓ 锚点：数字 3-5℃/40℃ + 具体时间 12 月
      ...
      { name: '大雁塔', era: '唐·652年', hookShort: '玄奘在此译经 19 年，每天译一千多字古梵文。', whyVisit: '玄奘 652 年奏请唐高宗建此塔，用来存放他从印度取回的 657 部梵文经书——原是五层 60 米的砖木结构，武则天 704 年重修为今天的七层 64 米纯砖体。塔身青砖中间夹有木芯，能在地震中微微弯而不断裂——1556 年关中 8 级大地震，民房毁 60 余万间，大雁塔只倒了塔顶三尺。玄奘 629 年离开长安那年，穆罕默德在麦地那病逝 3 个月，阿拉伯半岛开始扩张——东西两端都有宗教人物在改变历史的路径。回来后他在慈恩寺译场前后 19 年译经 75 部共 1335 卷，平均每天译一千多字古梵文，从未间断。现在登塔内木梯窄如井，你在塔顶看到的城市轮廓，玄奘见过一次，从此再没见过。', yearNum: 652, wiki: 'Giant Wild Goose Pagoda', gradient: 'linear-gradient(135deg, #2A1A0A 0%, #6B4A2A 50%, #1A0D00 100%)', desc: '唐僧玄奘为保存从印度带回的经文而修建，是丝绸之路文化交流的见证。', hours: '08:00—17:30', ticket: {
  ...
  },
  {
    ...
    text: '地铁 3 号线“大雁塔”站 C 出口直达北广场，换乘 4 号线 1 站能到大唐不夜城 + 回民街' // ✓ 锚点：具体名字 3 号线 C / 4 号线 + 数字 1 站
      ...
      { name: '回民街', era: '唐代起', hookShort: '一座清真寺长得像道观——歇山顶、飞檐、照壁。', whyVisit: '北院门、化觉巷、西羊市这几条小巷住着 6 万回族后裔——许多家族的族谱追到唐代的阿拉伯或波斯商人，沿丝绸之路从长安西门进城后就再没离开。化觉巷清真大寺建于唐天宝元年（742 年），完全中国式建筑形制（歇山顶、飞檐、照壁）却是礼拜堂——一座清真寺长得像道观。同年高仙芝正攻占小勃律，9 年后在怛罗斯被阿拉伯人击败——那场战役的唐军俘虏把造纸术带到撒马尔罕，5 年后传到巴格达。泡馍馆子用羊骨熬汤 6 小时起，掰馍讲究"黄豆粒大"。夜里 11 点后真正的老回民会拎着茶壶到北院门坐着下象棋，空气里是羊油、孜然和慢火茶混合的味道。', yearNum: 700, wiki: 'Drum Tower of Xi\'an', gradient: 'linear-gradient(135deg, #4A1A0A 0%, #C94A1A 50%, #2A0A00 100%)', desc: '西安穆斯林聚居区，千年来的丝路商旅后裔。这里的美食融合了中原与西域风味。', hours: '全天（小吃摊约10:00—22:00）', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '红堡', era: '莫卧儿·1648年', hookShort: '墙上刻着："人间若有天堂，就是这里，就是这里，就是这里。"', whyVisit: '{tag: 莫卧儿·1648 年｜墙高 33 米·周 2.4 公里}\n\n红砂岩墙高【33 米】、周长【2.4 公里】——【1648】年沙贾汗迁都时工匠用焦特布尔【600 公里】外的红砂岩运来砌成，日落时整面外墙像一块烧红的铁。主门拉合尔门即每年【8 月 15 日】印度总理发表独立日讲话的位置，自【1947】年尼赫鲁起未变。\n\nDiwan-i-Am（公众大殿）的「孔雀宝座」原镶【108】颗红宝石、【116】颗祖母绿、【186 克拉】的光之山钻石——【1739】年波斯纳迪尔沙洗劫德里时带走，现在光之山在英女王王冠里。Diwan-i-Khas 墙上刻着波斯语：「如果人间有天堂，那就是这里，就是这里，就是这里。」三遍。\n\n同年清乾隆四年，北京正兴文字狱——东西两端都在用「文化统一」掩盖帝国焦虑，一个砸字，一个镶金。', yearNum: 1648, wiki: 'Red Fort', wikiImage: 'https://commons.wikimedia.org/wiki/Special:FilePath/Delhi-Red_Fort-Lahori_Gate-20080210.jpg?width=1600', gradient: 'linear-gradient(135deg, #8B1A1A 0%, #C94A2A 50%, #4A0A0A 100%)', desc: '莫卧儿皇帝沙贾汗建造的红砂岩宫殿，城墙高33米。每年独立日总理在此发表讲话。', hours: '09:30—16:30，周一闭馆', ticket: {
  ...
  },
  {
    ...
    text: '凉季（11-2 月）早晚 8-12℃ + 雾霾 AQI 300+，口罩 + 眼药水是必备；夏季 45℃ 以上进城墙地板烫脚' // ✓ 锚点：具体时间 11-2 月 + 数字 8-12℃ / AQI 300/45℃
      ...
      { name: '顾特卜塔', era: '德里苏丹·1199年', hookShort: '塔身石料拆自 27 座印度教与耆那教庙宇。', whyVisit: '72.5 米高，1199 年开工，由德里苏丹国首任苏丹顾特卜丁·艾伊拜克建造——他是奴隶出身的突厥将军，名字意为"信仰之轴"。五层结构，每层雕刻风格不同：底层是印度教莲花与藤蔓——工匠是被征服的印度教徒，苏丹下令不准刻人像，他们就偷偷保留了母题。塔身红砂岩来自拆除的 27 座印度教与耆那教庙宇，柱廊上至今能看到被部分抹掉的神像，有的脸被凿平却留着耳环。1199 年同期南宋庆元五年，朱熹刚去世——一边在磨哲学，一边在用异教庙宇砌塔，两种"征服"同时发生。塔顶原有凉亭 1803 年被雷击毁后未复建，塔身现略向西南倾 65 厘米。', yearNum: 1199, wiki: 'Qutub Minar', gradient: 'linear-gradient(135deg, #4A2A0A 0%, #8B5A2A 50%, #2A1A00 100%)', desc: '高72.5米，是世界上最高的砖砌宣礼塔。五层结构融合了印度教和伊斯兰建筑风格。', hours: '07:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '景区内 1600 年铁柱 Iron Pillar 不生锈的冶金之谜，柱身现有护栏但仍可近距离 1 米观察表面' // ✓ 锚点：具体名字 Iron Pillar + 数字 1600 年 / 1 米 + 只有去过才知道
      ...
      { name: '胡马雍陵', era: '莫卧儿·1570年', hookShort: '泰姬陵直接复制了它的形制——只是更大、更白。', whyVisit: '1570 年建成，印度次大陆第一座"花园陵墓"——八角主体立在 30 亩波斯式四分花园中央，水渠从中心向四方流出象征伊斯兰天堂的四条河。86 年后沙贾汗为爱妻建的泰姬陵直接复制了它的形制——但更大、更白、更对称。胡马雍本人死得戏剧：1556 年在自己图书馆听见阿訇呼礼，下楼时失足从大理石台阶摔死。寡妻哈吉·贝古姆花 9 年、动用 300 位波斯与印度工匠，砌成红砂岩主体 + 白色大理石穹顶——莫卧儿"红白建筑语言"首次登场。同期东方明嘉靖至隆庆年间，张居正刚入内阁——东西两端的帝国都在用建筑物演练"权力的传承"。中央棺椁只是衣冠墓，真正的遗体葬在地宫下层。', yearNum: 1570, wiki: "Humayun's Tomb", gradient: 'linear-gradient(135deg, #2A1A1A 0%, #6B4A3A 50%, #1A0D0D 100%)', desc: '莫卧儿建筑的先驱之作，对称的波斯式花园陵墓直接启发了泰姬陵的设计。', hours: '日出—日落', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '西墙（哭墙）', era: '前19年', hookShort: '最底一层 570 吨的石块——至今没人解释怎么搬上去。', whyVisit: '{tag: 前 19 年｜最大石块 570 吨·三教叠层}\n\n不是圣殿本体，只是第二圣殿外围护墙西段——【488 米】长的原墙地表可见仅【57 米】。最底【七】层是希律王公元前【19】年扩建时的石块，最大一块重【570 吨】，至今没人解释用什么机械搬上去。\n\n上面【四】层是倭马亚【7 世纪】砌的小石块，再上面是奥斯曼【16 世纪】的更小石块——这面墙本身是一部三教叠加的地质学，往上看一眼就能看完 2000 年。塞纸条的习俗起于【18 世纪】，现在每年【100 万】张，每半年由拉比收出来埋到橄榄山上——不可烧、不可扔。\n\n同年东方汉成帝河平三年，王莽正往上爬——一边帝国要亡，一边圣殿要建，都在用石头和权力做最后的姿势。', yearNum: -19, wiki: 'Western Wall', gradient: 'linear-gradient(135deg, #4A3A2A 0%, #8B7A5A 50%, #2A1A0A 100%)', desc: '第二圣殿仅存的遗迹，犹太教最神圣的祈祷场所。信徒将祈祷纸条塞入墙缝已有数百年传统。', hours: '24小时开放', ticket: {
  price: '免费 · 24 小时开放',
  channels: [
  ...
  },
  {
    ...
    text: '塞祈祷纸条是数百年传统；如果是自己塞必须卷紧推进石缝最深处——每月清扫后纸条全部埋在橄榄山墓地' // ✓ 锚点：具体名字橄榄山墓地 + 只有去过才知道 + 具体时间每月
      ...
      { name: '圆顶清真寺', era: '倭马亚·691年', hookShort: '一块石头承载三教终极叙事——建筑史上仅此一例。', whyVisit: '金色穹顶直径 20 米，1993 年约旦国王侯赛因卖掉自己房产凑 650 万美元重镀——80 公斤纯金压成 0.000024 毫米厚的金箔。穹顶下的"基石"被三个宗教同时认作终极地标：犹太教相信这是上帝造世的第一块石头，伊斯兰教相信这是穆罕默德 621 年夜行登霄起飞点，基督教相信这是亚伯拉罕献祭以撒的祭台。一块石头承载三个宗教的终极叙事，建筑史上仅此一例。691 年建成同期中国武周神功元年，武则天正在洛阳建明堂——东西两端刚僭越的权力不约而同用建筑盖章。非穆斯林可在周日至周四 7:30-10:30 进圣殿山，但不能进清真寺内部。', yearNum: 691, wiki: 'Dome of the Rock', gradient: 'linear-gradient(135deg, #1A3A1A 0%, #C9963A 50%, #0D2A0D 100%)', desc: '伊斯兰世界最标志性的建筑之一，金色穹顶下是先知穆罕默德登霄之处的圣石。', hours: '非穆斯林参观时间有限', ticket: {
  ...
  },
  {
    ...
    text: 'Mughrabi Gate 在西墙广场南端 + 木栈桥入口；除此之外所有圣殿山 10 个门都只对穆斯林开放' // ✓ 锚点：具体方向南端 + 数字 10 个门 + 具体名字
      ...
      { name: '圣墓教堂', era: '拜占庭·335年', hookShort: '六个教派共管，钥匙却交给两个穆斯林家族——800 年没变。', whyVisit: '六个基督教派共管——罗马天主教、希腊东正教、亚美尼亚、科普特、埃塞俄比亚、叙利亚——钥匙却由两个穆斯林家族世代掌管：努塞贝持钥匙，朱达负责开门，这个制度从 1187 年萨拉丁收复耶路撒冷起延续到今天，800 年没变。教堂内挤着苦路最后五站：被钉、取下、涂膏、埋葬、复活。2016 年希腊文物专家打开圣墓亭石板，发现石灰岩床保存完好，拍完照重新封上，下一次打开可能要等几百年。335 年建时同期西晋已亡，东晋司马昱朝，佛教刚传入洛阳——一边竖十字，一边立佛塔，东西两端的宗教建筑几乎同步进入帝国时代。', yearNum: 335, wiki: 'Church of the Holy Sepulchre', gradient: 'linear-gradient(135deg, #2A1A2A 0%, #6A4A6A 50%, #1A0D1A 100%)', desc: '基督教最神圣的教堂，相传建在耶稣受难和复活之处。六个基督教派系共同管理这座教堂。', hours: '04:00—19:00（夏季延至21:00）', ticket: {
  price: '免费',
  channels: [
    {
  ...
  },
  {
    ...
    landmarks: [
      { name: '吴哥窟主殿', era: '高棉·约1150年', hookShort: '被遗忘四百年，1861 年法国博物学家才重新推开丛林。', whyVisit: '{tag: 高棉·约 1150 年｜30 万工匠·6000 头象}\n\n护城河宽【190 米】、全长【5.5 公里】——环绕一座石头城市的水道宽得可以当运河走船。主殿中央塔【65 米】高，与四座副塔共同象征「须弥山五峰」。日出时从西门进入，走【350 米】西参道到荷花池东岸，五塔尖的倒影正好落在水面——柬埔寨国旗的图案就是这个角度。\n\n约【1150】年建成动用【30 万】工匠、【6000】头大象。浮雕回廊长【800 米】——「搅乳海」一段，阿修罗与天神用蛇拽住须弥山转 1000 年挤出甘露。【1432】年后此都被遗忘【400 年】，【1861】年法国博物学家亨利·穆奥才重新发现它——当他的向导砍开丛林时，一棵木棉树的根已经从佛头上长了出来。\n\n同期南宋绍兴二十年，秦桧刚死五年；西方第二次十字军东征刚失败——东西两端都在打仗，中南半岛丛林里却完成了人类史上最大的宗教建筑。', yearNum: 1150, wiki: 'Angkor Wat', wikiImage: 'https://commons.wikimedia.org/wiki/Special:FilePath/Angkor_Wat_temple.jpg?width=1600', gradient: 'linear-gradient(135deg, #2A3A1A 0%, #6B8A4A 50%, #1A2A0A 100%)', desc: '世界最大的宗教建筑，护城河宽190米，中央塔高65米。日出时五座塔尖的倒影是柬埔寨国旗的灵感来源。', hours: '05:00—17:30', ticket: {
  ...
  },
  {
    ...
    text: '5-9 月雨季午后 30 分钟暴雨但比起烈日凉爽；11-2 月凉季清晨 15℃ 日出时寒冷，带外套' // ✓ 锚点：具体时间 5-9 月/11-2 月 + 数字 30 分钟 / 15℃
      ...
      { name: '巴戎寺', era: '高棉·1200年', hookShort: '216 张石面，每张都是国王本人的脸。', whyVisit: '216 张巨大的石面佛像，按 54 座高塔每塔 4 面雕刻而成——这个数字是阇耶跋摩七世时期高棉帝国 54 个行省总数，意思是"国王之眼遍视全境"。每张脸都微笑，眯眼、厚唇、略带嘲讽——考古学家认为这是国王本人的面容，他把自己雕成观世音菩萨复制 216 份放在天空。"国王即神"的叙事比路易十四"朕即国家"早 500 年。同期南宋末年、日本镰仓时代——东西两端都在制作独裁美学。下层回廊浮雕不像吴哥窟画神话，而是画平民：集市、斗鸡、产婆接生、和中国商人做生意——12 世纪东南亚最完整的市井画廊。清晨 6-7 点雾未散，216 张脸一起浮现，那一刻你会突然理解什么叫"被监视"。', yearNum: 1200, wiki: 'Bayon', gradient: 'linear-gradient(135deg, #3A3A1A 0%, #8B8A5A 50%, #1A1A0A 100%)', desc: '216张巨大的石面微笑俯瞰四方，被称为“高棉的微笑”。浮雕墙面描绘了高棉人的日常生活。', hours: '07:30—17:30', ticket: {
  ...
  },
  {
    ...
    text: '从巴戎寺出向北 800 米到象台 + 麻风王台 + 空中宫殿，是吴哥通王城核心三景；步行串游 1 小时' // ✓ 锚点：具体方向北 800 米 + 具体名字象台 + 数字 800 米 / 1 小时
      ...
      { name: '塔布隆寺', era: '高棉·1186年', hookShort: '绞杀榕的根钻进石缝、撑裂石墙、重新粘合。', whyVisit: '绞杀榕的气根从寺顶砸下，钻进石缝、撑裂石墙、重新粘合——法国远东学院 1907 年首次清理吴哥时特意保留这座寺的原貌：让自然对文明的吞噬被看见。最大一棵榕树根直径 6 米，需 8 人环抱，从 16 世纪就开始生长——400 年前树籽掉进一块石头缝，没人去拔，就有了今天的画面。1186 年阇耶跋摩七世为母亲所建，供奉"智慧之母"；同期南宋淳熙十三年，朱熹刚完成《四书章句集注》初稿——一边给母亲造庙，一边给天下编教材。真正值得花 30 分钟的是西侧回廊尽头——一棵 500 年木棉树把一尊湿婆像完全包进树干，只剩一只半张的眼睛从树皮缝隙里看你。', yearNum: 1186, wiki: 'Ta Prohm', gradient: 'linear-gradient(135deg, #1A2A1A 0%, #4A6A3A 50%, #0D1A0D 100%)', desc: '被巨大的绞杀榕树根盘绕的寺庙，保留了法国考古学家发现时的原貌。因《古墓丽影》电影取景而闻名。', hours: '07:30—17:30', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '德吉玛·艾尔法纳广场', era: '11世纪起', hookShort: '一把老虎钳一只锡盆——街头拔牙师至今真的存在。', whyVisit: '{tag: 11 世纪起｜100+ 食摊 30 分钟搭起}\n\n白天这里是市集、药草贩、耍蛇人、拔牙师——街头拔牙师至今真的存在，一把老虎钳一只锡盆，一颗牙【20】迪拉姆。入夜后广场 180 度转台：【100+】个食摊【30 分钟】内搭起，每摊编号，各家只做一两样——蜗牛汤、羊头、烤沙丁鱼——「专攻一菜」的密度地中海独一份。\n\n【2001】年联合国教科文组织把它列入首批【19】项「人类口头非遗」，理由是 Halqa 讲故事传统：讲古人围圈传承的柏柏尔语故事一旦讲完就没了——没有录音、没有手稿，只靠下一代听着长大。日落时整个广场的音响从远到近一齐翻起，是非洲最古老的人声浪。\n\n【11 世纪】建城同期北宋庆历年间，包拯刚任开封府尹——一边把故事写进《清明上河图》做凝固档案，一边讲进沙漠夜空做流动遗产。', yearNum: 1050, wiki: 'Jemaa el-Fnaa', gradient: 'linear-gradient(135deg, #4A2A0A 0%, #C9763A 50%, #2A1A00 100%)', desc: '北非最繁忙的广场，白天是市集，入夜后变成露天大排档和表演场。联合国教科文组织将其列为“人类口头和非物质文化遗产”。', hours: '全天（夜晚最热闹）', ticket: {
  price: '完全免费；夜市摊位消费另计',
  channels: [
  ...
  },
  {
    ...
    text: '夏季白天 45℃+ 傍晚降至 28-32℃ 体感最好；冬季 12-2 月夜间 8-12℃ 广场凉风需外套' // ✓ 锚点：数字 45℃/28-32℃/8-12℃ + 具体时间夏季冬季
      ...
      { name: '库图比亚清真寺', era: '穆瓦希德·1147年', hookShort: '全城不得高于一棵棕榈——这条 1147 年的规矩还在。', whyVisit: '77 米高的宣礼塔是马拉喀什最高建筑——城市法规规定任何建筑物不得超过一棵棕榈树的高度，即不得高于 Koutoubia——这条 1147 年穆瓦希德王朝定的规矩延续近 900 年，所以你在老城任何位置抬头都能看到它。它是塞维利亚吉拉尔达塔和拉巴特哈桑塔的设计原型——一母三女散落马格里布-安达卢西亚文化圈。塔身原本全覆红灰泥雕花、顶嵌四颗金球（据说是某位苏丹妻子赎罪熔掉的首饰）。1147 年建成同期南宋绍兴十七年，岳飞冤死后 6 年——东西两端都在用建筑重整"忠诚"的定义。非穆斯林不允许进入内部，花园全天开放。黄昏时整座塔被赤陶红光染透，40 分钟像一块熔铁。', yearNum: 1147, wiki: 'Koutoubia Mosque', gradient: 'linear-gradient(135deg, #3A2A0A 0%, #8B6A3A 50%, #1A0D00 100%)', desc: '马拉喀什最高的建筑（77米），其宣礼塔是塞维利亚吉拉尔达塔和拉巴特哈桑塔的设计原型。', hours: '非穆斯林不可进入', ticket: {
  ...
  },
  {
    ...
    text: '花园内虽然免费但宗教场所氛围，穿长裤 / 过膝裙更得体；情侣避免高调亲密行为' // ✓ 锚点：只有去过才知道
      ...
      { name: '巴希亚宫', era: '19世纪·1867年', hookShort: '大维齐尔给爱妾盖的宫——法国总督后来住进了她的卧室。', whyVisit: '名字意思是"美人之宫"——19 世纪末大维齐尔 Bou Ahmed 给最爱的小妾盖的（他有 4 位正妻、24 个小妾）。150 个房间，菲斯工匠花 7 年完工，1900 年 Bou Ahmed 一死宫殿就被苏丹抄家、女人流放——"因宠而生、因死而散"在摩洛哥宫廷是常态。小院中央喷泉四周 4 扇门对应四季：春绿、夏红、秋黄、冬蓝。同期清光绪年间慈禧正在修颐和园——东西两端的权贵都在给后宫花天价建视觉舞台。屋顶雪松木雕 1500 种纹样全部手工，菲斯最好的工匠一人一年只能做 3 平米。1912 年法国保护国成立后，首任总督 Lyautey 就住在这里办公——殖民者住进了小妾的卧室。', yearNum: 1867, wiki: 'Bahia Palace', gradient: 'linear-gradient(135deg, #1A2A2A 0%, #4A6A6A 50%, #0D1A1A 100%)', desc: '摩洛哥伊斯兰建筑的精华，150个房间装饰着精美的雪松木雕、马赛克瓷砖和大理石地板。', hours: '09:00—17:00', ticket: {
  ...
  },
  {
    ...
    landmarks: [
      { name: '大神庙遗址', era: '阿兹特克·1325年', hookShort: '1978 年一个电工挖电缆，锄头砸中 8 吨重的月亮女神。', whyVisit: '{tag: 阿兹特克·1325 年｜埋 450 年出土}\n\n1978 年一个电工挖电缆，锄头砸中 8 吨重的月亮女神——阿兹特克帝国的心脏，在一座殖民者的教堂地下埋了 450 年才被一次市政工程偶然揭开。\n\n【1978】年【2 月 21 日】一个电工在大教堂旁边挖电缆，锄头砸中【8 吨】重圆石——科约尔沙乌基浮雕直径【3.25 米】。这块石头引出整座大神庙——阿兹特克首都特诺奇蒂特兰的心脏，【1521】年被科尔特斯拆毁用来砌大教堂。金字塔原高【60 米】，【七】次扩建，每次把前一版整个包进去——考古学家今天可以像洋葱一样剥开看，一座神庙里叠着七座神庙。\n\n【1521】年陷落同期中国明嘉靖元年，王阳明刚病逝、心学在江南传开——东西两端都在整理「人与天的关系」，一边用哲学，一边用血。', relatedLiterature: [{ title: '《征服新西班牙信史》', author: '贝尔纳尔·迪亚斯', year: 1568, quote: '我们站在神庙顶上看到这座城，没人相信这是真的', link: '一个士兵在科尔特斯抵达那天写下第一印象' }], yearNum: 1325, wiki: 'Coyolxauhqui Stone', gradient: 'linear-gradient(135deg, #4A2A0A 0%, #8B5A2A 50%, #2A1A00 100%)', desc: '阿兹特克帝国最重要的宗教建筑遗址，1978年偶然出土。金字塔式神庙曾高60米，供奉雨神和战神。', hours: '09:00—17:00，周一闭馆', ticket: {
  ...
  },
  {
    ...
    text: '遗址面积不大（100 米 × 80 米）但双塔基座分别供雨神 Tlaloc + 战神 Huitzilopochtli，北南双塔地层由外向内扩建 7 层' // ✓ 锚点：数字 100 米/80 米/7 层 + 具体名字 Tlaloc / Huitzilopochtli
      ...
      { name: '国家宫殿', era: '殖民·1563年', hookShort: '脚下的石板来自阿兹特克大神庙——征服者拆了它，盖了自己。', whyVisit: '建在阿兹特克最后一位皇帝蒙特祖玛二世的宫殿废墟上——1521 年科尔特斯拆掉皇宫，用同一批石头盖了这座 1563 年的西班牙总督府。"征服者用被征服者的骨头造房子"在这里是字面意义。二层楼梯墙上是迭戈·里维拉 1929-35 年绘的《墨西哥历史》，450 平米——中央是马克思指向未来，左下角科尔特斯的鼻子画成一个梅毒塌陷的洞（他得过梅毒，史实）。里维拉作画同期民国二十四年，上海《申报》连载老舍《骆驼祥子》——东西两端都在用艺术审判自己的国家。总统每年 9 月 15 日独立日前夜从阳台敲响 Hidalgo 钟，重演 1810 年伊达尔戈起义的钟声。', yearNum: 1563, wiki: 'National Palace (Mexico)', gradient: 'linear-gradient(135deg, #3A1A1A 0%, #6B3A3A 50%, #1A0D0D 100%)', desc: '建在阿兹特克皇帝蒙特祖玛宫殿的遗址上，内有迭戈·里维拉绘制的巨幅壁画《墨西哥历史》。', hours: '09:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: 'Zócalo 宪法广场东侧正对；从地铁 Zócalo 站出步行 100 米；与大神庙遗址相邻 200 米，是一条动线上的连游' // ✓ 锚点：具体名字 Zócalo + 数字 100 米/200 米
      ...
      { name: '墨西哥城大教堂', era: '1573—1813年', hookShort: '盖了 240 年，脚下的石头是阿兹特克神庙的尸骨。', whyVisit: '{tag: 跨 240 年｜压在神庙之上}\n\n一座教堂盖了 240 年，换了 16 位建筑师、3 种风格——它不是「建」起来的，是一层层叠出来的；脚下的石头是阿兹特克神庙的尸骨，头顶的穹顶是文艺复兴晚期的遗言。\n\n【1573】年奠基时用的石材，【一半】来自拆毁的大神庙——科尔特斯命令把阿兹特克金字塔的方石搬过来砌教堂，留到今天仍能在西侧墙基看见带雕刻的神庙石块。教堂因建在湖床上，每年下沉【不均匀】，1990 年代工程师用【32 个】液压千斤顶把塔楼整体扶正了【1.5 米】。内部【16】个小教堂沿十字形环绕，金祭坛由【秘鲁银】打造——哈布斯堡王朝把殖民地白银的【五分之一】都用在这里。\n\n【1813】年完工那年拿破仑刚从俄国退回巴黎——墨西哥城用两个半世纪完成一栋建筑，欧洲大陆用两年完成一场溃败。', yearNum: 1573, wiki: 'Metropolitan Cathedral, Mexico City', gradient: 'linear-gradient(135deg, #3A1A0A 0%, #8B5A2A 50%, #1A0D00 100%)', desc: '建于 1573—1813 年，跨越 240 年由 16 位建筑师接力完成，融合文艺复兴、巴洛克与新古典三种风格；位于 Zócalo 广场北侧，压在阿兹特克大神庙遗址之上。', hours: '08:00—20:00', tags: ['殖民建筑', '世界遗产', '巴洛克'], note: '建在湖床上至今仍在不均匀下沉，1990 年代曾用 32 个液压千斤顶扶正塔楼。' },
      { name: '特奥蒂瓦坎', era: '前200年—650年', hookShort: '没人知道这里的人是谁——他们讲什么语言至今不明。', whyVisit: '{tag: 前 200—650 年｜20 万人口之城}\n\n没人知道这里的人是谁——他们讲什么语言、写什么字、信什么神，至今不明。一座当时世界第六大城市消失得像从未存在过，只留下两座金字塔让后来者命名。\n\n太阳金字塔高【65 米】、底边【220 米】——美洲第三大金字塔。鼎盛期（公元【450 年】）这里有【20 万】人口，比同期君士坦丁堡大、比长安小。阿兹特克人【千年后】看见这座空城，用自己的话称它 "Teotihuacan"（众神所生之地）。【6 世纪】它突然被焚毁、人口消失——全世界最大的消失谜团之一。登顶【248 级】台阶，陡到【45 度】必须弯腰——这是祭司在神前谦卑的设计。\n\n同期东方北魏洛阳白马寺正翻修，西方罗马刚被西哥特人洗劫——东西两端的帝国都进入崩溃前最后一段繁荣。', yearNum: 200, wiki: 'Teotihuacan', gradient: 'linear-gradient(135deg, #4A3A1A 0%, #C9963A 50%, #2A1A00 100%)', desc: '距墨西哥城50公里的古代大都会遗址，太阳金字塔高65米，是美洲第三大金字塔。鼎盛时期人口达20万。', hours: '09:00—17:00', ticket: {
  ...
  timingTip: '选 6:00 首批入场（雾气缭绕的神性视角）或 14:00 后（团客离场、光线金色）；2 月雨季封闭，1 月 / 3 月泥泞需防水鞋'
      ...
      { name: '太阳神殿', era: '印加·约1450年', hookShort: '没有金属工具、没有轮子——却把冬至锁进一道石缝。', whyVisit: '半圆形建筑是马丘比丘唯一的弧形墙——整座城都是直线直角，只有这里给太阳留了一个弧形。东墙两扇梯形窗：冬至日（南半球 6 月 21 日）清晨第一缕光精确穿过东南窗，落在中央的花岗岩祭坛上——印加人用这个装置确认一年最短白昼。精度与英格兰巨石阵夏至对齐同级，但印加人没有书写系统、没有金属工具、没有轮子——仅靠绳结记忆（quipu）和凿刻完成。1450 年同期西方英格兰玫瑰战争前夜，亨利六世精神崩溃在即；东方明景泰年间——东西两端都在王权动荡中，秘鲁山巅却用石头把太阳封住。神殿下方岩洞是"皇陵"，1911 年宾厄姆发现木乃伊全运到耶鲁，2011 年才归还秘鲁。', yearNum: 1450, wiki: 'Torreon (Machu Picchu)', wikiImage: 'https://upload.wikimedia.org/wikipedia/commons/1/1a/Machu_Picchu_Torre%C3%B3n.jpg', gradient: 'linear-gradient(135deg, #1A3A1A 0%, #4A8A4A 50%, #0D2A0D 100%)', desc: '半圆形建筑精确对准冬至日出方向，展现了印加人卓越的天文学知识。石墙贴合之紧密，无法插入一张纸。', hours: '06:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '位于主遗址西区中段；从主入口沿 Circuito 2 走 400 米即达；塔下方洞穴是“皇陵”需弯腰进入（非所有团均经过）' // ✓ 锚点：具体方向西区 + 数字 400 米
      ...
      { name: '拴日石（Intihuatana）', era: '印加·约1450年', hookShort: '盖丘亚语意为"拴住太阳的地方"——春分正午不投阴影。', whyVisit: '一块精心凿刻的花岗岩柱，顶部短柱朝东南偏北——春分秋分正午太阳悬在石柱正上方，不投任何阴影。盖丘亚语"Intihuatana"意为"拴住太阳的地方"：印加祭司相信太阳夏至后会北漂，必须在这里举行仪式"拉住它"让它回头。西班牙入侵者每到一个印加城市就首先砸毁 Intihuatana——视之为最危险的偶像——马丘比丘因被遗忘而成为全秘鲁唯一完整保存的一座。同期明代天文学中衰期，郭守敬《授时历》一直用到 1644 年；西方伽利略出生前 100 年——东西两端都在用不同工具校准时间，印加人用石头、明人用铜尺、伽利略用望远镜。2000 年一台拍广告的起重机砸坏石柱顶部一角，现在 3 米外不得靠近。', yearNum: 1450, wiki: 'Intihuatana', gradient: 'linear-gradient(135deg, #2A3A2A 0%, #6B8A5A 50%, #1A2A1A 100%)', desc: '这块精心雕刻的花岗岩被认为是印加人的天文仪器，在春分和秋分时太阳正好悬在石柱正上方，不投下任何影子。', hours: '随马丘比丘开放', ticket: {
  ...
  },
  {
    ...
    text: '从主入口沿 Circuito 1 走 600 米 + 爬 50 级台阶到顶；是遗址海拔最高的观景点（2460 米），天气清时可俯瞰整个马丘比丘城' // ✓ 锚点：数字 600 米/50 级/2460 米
      ...
      { name: '华纳比丘', era: '印加时期', hookShort: '印加石阶坡度 70 度、两侧悬崖——550 年前就在走。', whyVisit: '比马丘比丘高 260 米的尖峰，形似面包——盖丘亚语"年轻的山峰"，相对 Machu（老）Picchu 而言。攀登约 1 小时，部分路段是印加人凿进岩壁的"石阶"：宽 30 厘米、坡度 70 度、两侧悬崖——这条路 550 年前就在使用，祭司每天清晨爬上去观察日出方向，验证太阳神殿里的对齐是否准确。顶部只有 5 平米平台，每天只放 400 张票。同期东方明正统景泰交替期——东西两端的帝国都在山与山之间寻找观测点。背面有月亮神庙，藏在山腹的天然岩洞里。山顶西北俯瞰整座马丘比丘，你会看到这座城在山脊上的形状像一只正要起飞的神鹰（Condor）——印加人所有城市规划都嵌入这种隐形图腾。', yearNum: 1450, wiki: 'Huayna Picchu', gradient: 'linear-gradient(135deg, #0A2A0A 0%, #3A6A3A 50%, #0D1A0D 100%)', desc: '马丘比丘背后的尖峰，攀登需约1小时。山顶可俯瞰整个马丘比丘遗址和乌鲁班巴河谷的壮观景色。', hours: '07:00—08:00 入场（两批次）', ticket: {

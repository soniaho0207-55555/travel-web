...
const CITIES = [
  {
    ...
    timeline: [
      ...
      { year: '公元938年', event: '辽代南京', desc: '契丹辽朝将燕京升格为南京，作为五京之一，城市规模大幅扩张。', worldContext: '此时世界：北宋刚建立 18 年，欧洲神圣罗马帝国奥托一世正在重建西方皇权；玛雅古典期刚刚崩塌' },
      { year: '1153年', event: '金朝迁都中都', desc: '金海陵王完颜亮迁都至此，北京首次成为全国性政治中心。' },
      { year: '1271年', event: '元大都建成', desc: '忽必烈命刘秉忠规划建造元大都，棋盘式格局奠定了现代北京城市骨架。', worldContext: '此时世界：马可·波罗即将启程东方，将看见这座世界最大城市；欧洲正处十字军东征末期' },
      { year: '1406年', event: '永乐迁都·紫禁城破土', desc: '明成祖朱棣动员逾百万工匠，历时十四年建成紫禁城，共有宫殿九千余间。', worldContext: '此时世界：明朝郑和次年首次下西洋；佛罗伦萨布鲁内莱斯基正在建造圣母百花大教堂穹顶；奥斯曼帝国还有 47 年攻陷君士坦丁堡' },
      { year: '1644年', event: '清军入关定鼎', desc: '清朝延续并扩建明代宫城格局，增建颐和园、圆明园等皇家园林。' },
      { year: '1860年', event: '英法联军火烧圆明园', desc: '第二次鸦片战争中圆明园被焚毁，成为中国近代史上最深重的文化创伤之一。', worldContext: '此时世界：美国南北战争即将爆发（1861）；日本黑船事件后 7 年，明治维新 8 年后到来；印度莫卧儿王朝两年前刚覆灭' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { year: '公元前509年', event: '共和国建立', desc: '罗马人驱逐最后一位国王，建立共和政体。', worldContext: '此时世界：波斯阿契美尼德帝国鼎盛，大流士一世正在修建波斯波利斯；同时孔子在山东曲阜周游列国，刚结束他的政治生涯' },
      { year: '公元前44年', event: '凯撒遇刺', desc: '凯撒在元老院被刺杀，此后屋大维建立帝国。', worldContext: '此时世界：汉武帝已驾崩 43 年，西汉进入霍光辅政后期；埃及托勒密王朝末代女王克里奥帕特拉正与罗马博弈' },
      { year: '公元80年', event: '斗兽场落成', desc: '科洛塞姆竣工，可容纳5万至8万观众。' },
      { year: '公元313年', event: '基督教合法化', desc: '君士坦丁颁布米兰敕令，罗马逐渐成为基督教世界的精神中心。', worldContext: '此时世界：中国西晋八王之乱刚结束，匈奴攻陷洛阳；印度笈多王朝即将建立，古典梵文文学进入黄金期' },
      { year: '公元476年', event: '西罗马帝国覆灭', desc: '末代皇帝被废黜，欧洲进入中世纪。', worldContext: '此时世界：中国南北朝对峙，北魏孝文帝准备汉化改革；玛雅文明进入古典期鼎盛，蒂卡尔城邦建成' },
      { year: '1506年', event: '圣彼得大教堂重建', desc: '米开朗基罗、拉斐尔等大师参与，历时120余年建成。', worldContext: '此时世界：哥伦布去世，麦哲伦环球航行前 13 年；明朝正德元年，紫禁城已建成 86 年；印加帝国进入鼎盛晚期' },
  ...
  },
  {
    ...
    timeline: [
      { year: '公元前657年', event: '拜占庭城建立', desc: '希腊移民在金角湾与博斯普鲁斯海峡交汇处建立殖民地。', worldContext: '此时世界：中国春秋时代孔子出生前 106 年；印度佛陀出生前 100 年；罗马刚结束王政时代' },
      { year: '公元330年', event: '君士坦丁堡建都', desc: '君士坦丁大帝将帝国首都东迁，更名"新罗马"。', worldContext: '此时世界：中国西晋刚统一 50 年；玛雅古典期开端；印度笈多王朝即将建立' },
      { year: '537年', event: '圣索菲亚大教堂落成', desc: '查士丁尼一世建造，穹顶直径31米，拜占庭建筑最高成就。' },
      { year: '1204年', event: '第四次十字军劫掠', desc: '十字军攻打君士坦丁堡，大量珍宝流失西方。', worldContext: '此时世界：中国南宋偏安，金朝统治北方；成吉思汗正在统一蒙古诸部；玛雅古典期已崩溃' },
      { year: '1453年', event: '奥斯曼攻陷君士坦丁堡', desc: '穆罕默德二世率军攻破城墙，东罗马帝国灭亡。', worldContext: '此时世界：明朝土木堡之变后 4 年，大明国力从鼎盛转衰；佛罗伦萨美第奇家族掌权；古腾堡印刷术改变欧洲' },
  ...
  },
  {
    ...
    timeline: [
      { year: '794年', event: '平安京迁都', desc: '桓武天皇以唐长安城为蓝本规划建造平安京，此后400年贵族文化绽放。', worldContext: '此时世界：查理曼加冕前 6 年，西欧加洛林文艺复兴正炽；阿拉伯阿拔斯王朝建巴格达智慧宫；玛雅古典期接近尾声' },
      { year: '1185年', event: '武家时代开启', desc: '源氏在坛之浦海战中击败平氏，建立镰仓幕府。', worldContext: '此时世界：南宋偏安江南，朱熹集理学大成；第三次十字军东征筹备中；吴哥窟刚建成半世纪进入鼎盛' },
      { year: '1338年', event: '室町幕府建立', desc: '足利尊氏在京都建立幕府，枯山水庭园、能乐、茶道在此时代形成。' },
      { year: '1467年', event: '应仁之乱', desc: '十年内战使京都遭受严重破坏，日本进入战国时代。', worldContext: '此时世界：明朝成化年间；奥斯曼攻陷君士坦丁堡 14 年后；美第奇家族的洛伦佐掌权佛罗伦萨' },
      { year: '1603年', event: '德川幕府·江户时代', desc: '锁国政策下形成高度精炼的传统文化生态。', worldContext: '此时世界：中国明末万历末期，利玛窦在北京传教刚 2 年；英国伊丽莎白一世去世同年，莎士比亚创作《哈姆雷特》' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { year: '969年', event: '法蒂玛王朝建开罗', desc: '新城"al-Qāhira"即"胜利者"，是今日开罗之名由来。', worldContext: '此时世界：中国北宋建立 9 年；欧洲神圣罗马帝国奥托一世加冕；基辅罗斯即将皈依东正教' },
      { year: '1250年', event: '马穆鲁克王朝建立', desc: '突厥系马穆鲁克奴隶兵推翻阿尤布王朝，开启 260 年伊斯兰黄金期。今日伊斯兰老城的主要清真寺学校（madrasa）与街区格局大多成型于此时。', worldContext: '此时世界：中国南宋末期，蒙古已灭金；路易九世第七次十字军兵败曼苏拉被俘；忽必烈即位前 10 年' },
      { year: '1517年', event: '奥斯曼帝国并吞', desc: '开罗成为奥斯曼帝国最重要的行省城市。', worldContext: '此时世界：马丁路德贴出《九十五条论纲》同年；明朝正德年间，王阳明刚提出"知行合一"；西班牙科尔特斯前一年即将征服阿兹特克' },
  ...
  // ─── P1 CITIES ───────────────────────
  {
    ...
    timeline: [
      ...
      { year: '508年', event: '克洛维定都巴黎', desc: '法兰克国王克洛维将巴黎定为首都，奠定了法兰西文化的基础。', worldContext: '此时世界：东罗马查士丁尼即将即位（527），圣索菲亚 29 年后落成；中国南北朝对峙，佛教在中国全面兴盛' },
      { year: '1163年', event: '巴黎圣母院奠基', desc: '哥特式建筑的巅峰之作开始建造，历时近两百年完成。', worldContext: '此时世界：中国南宋乾道时期，朱熹集理学大成；日本源平合战正酣，武家时代即将开启；吴哥窟刚建成 50 年' },
      { year: '1682年', event: '路易十四迁往凡尔赛', desc: '太阳王在巴黎郊外建造了人类历史上最奢华的宫殿。' },
      { year: '1789年', event: '法国大革命', desc: '巴士底狱被攻克，自由、平等、博爱的理念从此改变世界。', worldContext: '此时世界：美国乔治·华盛顿同年就任首任总统；清朝乾隆 54 年，中国 GDP 占全球 1/3；日本宽政改革' },
      { year: '1889年', event: '埃菲尔铁塔建成', desc: '为世博会建造的临时建筑，却成为了巴黎永恒的象征。', worldContext: '此时世界：日本明治维新 21 年后颁布帝国宪法；清朝光绪 15 年，北洋舰队实力处亚洲第一；美国西部尚未完全开发' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { year: '公元前508年', event: '民主制度诞生', desc: '克里斯提尼改革，建立了人类历史上第一个民主政体。', worldContext: '此时世界：中国春秋末期，孔子 43 岁在鲁国周游；印度佛陀还健在（入灭 25 年后）；波斯大流士即将建波斯波利斯' },
      { year: '公元前447年', event: '帕特农神庙开建', desc: '伯里克利主持建造，菲迪亚斯负责雕塑，成为希腊古典艺术的巅峰。', worldContext: '此时世界：中国战国初期，墨子出生前后；印度阿阇世王征服诸国；波斯帝国全盛却无法阻止希腊崛起' },
      { year: '公元前338年', event: '马其顿征服', desc: '腓力二世在喀罗尼亚击败希腊联军，雅典独立时代结束。' },
      { year: '公元529年', event: '柏拉图学院关闭', desc: '查士丁尼下令关闭异教学校，持续九百年的雅典学术传统中断。', worldContext: '此时世界：查士丁尼一世同年颁布《查士丁尼法典》并开建圣索菲亚；中国南北朝梁武帝普通十年；日本钦明天皇即位' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { year: '1296年', event: '圣母百花大教堂动工', desc: '这座大教堂将成为城市的象征，穹顶问题困扰了建筑师一个多世纪。', worldContext: '此时世界：中国元代忽必烈统一中国 17 年；马可·波罗去年回威尼斯，即将口述《马可·波罗游记》；奥斯曼国即将建立' },
      { year: '1434年', event: '美第奇家族崛起', desc: '科西莫·德·美第奇成为佛罗伦萨实际统治者，开启了文艺复兴的黄金时代。', worldContext: '此时世界：中国明宣德九年，郑和最后一次下西洋；奥斯曼帝国复兴期，19 年后攻陷君士坦丁堡；印加帝国正在扩张' },
      { year: '1501年', event: '米开朗基罗雕刻大卫像', desc: '26岁的米开朗基罗用三年时间将一块被废弃的大理石变成了永恒。', worldContext: '此时世界：哥伦布第三次航行归来；中国明弘治十四年；日本战国时代初期；奥斯曼即将征服叙利亚' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { year: '公元前221年', event: '秦统一六国', desc: '秦始皇在咸阳建立第一个大一统帝国，统一文字、度量衡。', worldContext: '此时世界：罗马第一次布匿战争胜利 20 年后，正在对抗汉尼拔；埃及托勒密王朝鼎盛，亚历山大图书馆是地中海学术中心' },
      { year: '公元前202年', event: '汉朝定都长安', desc: '刘邦建立汉朝，长安城成为东方最大的城市。' },
      { year: '公元前138年', event: '张骞出使西域', desc: '汉武帝派张骞开辟丝绸之路，长安成为东西文明交汇的枢纽。', worldContext: '此时世界：罗马共和国征服地中海，迦太基覆灭；帕提亚帝国正在中亚扩张；丝路东端从此与西端连通' },
      { year: '618年', event: '唐朝定都长安', desc: '唐代长安人口逾百万，是当时世界上最国际化的都市。', worldContext: '此时世界：穆罕默德 4 年后迁徙麦地那（622），伊斯兰元年即将到来；拜占庭帝国与萨珊波斯正在进行最后大战' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { year: '1192年', event: '德里苏丹国建立', desc: '穆罕默德·古尔征服德里，伊斯兰政权开始统治北印度。', worldContext: '此时世界：中国南宋庆元年间，朱熹刚去世；日本源平合战落幕、武家时代开启；第三次十字军东征萨拉丁与狮心王正对峙' },
      { year: '1526年', event: '莫卧儿帝国建立', desc: '巴布尔在帕尼帕特击败苏丹军队，建立印度历史上最辉煌的帝国。', worldContext: '此时世界：明朝嘉靖五年；奥斯曼苏莱曼大帝鼎盛；西班牙科尔特斯已征服阿兹特克 5 年；马丁路德宗教改革 9 年后' },
      { year: '1648年', event: '沙贾汗迁都', desc: '莫卧儿皇帝沙贾汗建造红堡和沙贾汗纳巴德（旧德里）。' },
      { year: '1857年', event: '印度民族起义', desc: '反英起义失败后，莫卧儿帝国正式终结，英国直接统治印度。', worldContext: '此时世界：中国第二次鸦片战争爆发；美国内战前 4 年；日本黑船事件后 4 年，明治维新 11 年后到来' },
  ...
  },
  {
    ...
    timeline: [
      ...
      { year: '公元前586年', event: '巴比伦毁城', desc: '尼布甲尼撒二世摧毁第一圣殿，犹太人被掳至巴比伦。', worldContext: '此时世界：中国春秋中期，孔子 19 年后出生；印度佛陀出生前 30 年；波斯居鲁士大帝 47 年后征服巴比伦，犹太人得归回' },
      { year: '公元前19年', event: '希律王重建圣殿', desc: '大希律王扩建第二圣殿，西墙即是当年圣殿山的挡土墙遗迹。', worldContext: '此时世界：中国西汉成帝河平二年；罗马屋大维刚登基 8 年，帝国和平刚开始；耶稣 23 年后诞生' },
      { year: '公元70年', event: '罗马军队摧毁圣殿', desc: '提图斯攻陷耶路撒冷，第二圣殿被焚毁，犹太人大流散开始。', worldContext: '此时世界：东汉明帝永平十三年，佛教传入中国；罗马科洛塞姆正在修建，10 年后落成' },
      { year: '691年', event: '圆顶清真寺建成', desc: '倭马亚王朝在圣殿山上建造金色穹顶，成为伊斯兰圣地。' },
      { year: '1099年', event: '十字军攻陷耶路撒冷', desc: '第一次十字军东征攻占圣城，建立耶路撒冷王国。', worldContext: '此时世界：中国北宋哲宗元符二年，西夏建立已 61 年；日本平安时代末期，武家文化萌芽；宋江 / 苏轼同时代' },
    ],
    landmarks: [
  ...
  },
  {
    ...
    timeline: [
      { year: '802年', event: '高棉帝国建立', desc: '阇耶跋摩二世统一高棉，在荔枝山宣布建国。', worldContext: '此时世界：中国唐德宗贞元十八年，安史之乱后 40 年；欧洲查理曼加冕 2 年后；阿拉伯阿拔斯王朝鼎盛' },
      { year: '约1150年', event: '吴哥窟建成', desc: '苏耶跋摩二世建造了这座献给毗湿奴的石构神庙，是世界最大宗教建筑。', worldContext: '此时世界：中国南宋绍兴二十年；巴黎圣母院奠基前 13 年；第二次十字军东征刚结束；玛雅后古典期' },
      { year: '1181年', event: '阇耶跋摩七世即位', desc: '建造了吴哥通王城和巴戎寺，帝国达到领土最大范围。' },
      { year: '1431年', event: '暹罗军队攻陷吴哥', desc: '高棉帝国南迁金边，吴哥遗址逐渐被热带丛林吞没。', worldContext: '此时世界：明朝宣德六年，郑和六下西洋；圣女贞德被处决同年；奥斯曼帝国征服前 22 年' },
  ...
  },
  {
    ...
    timeline: [
      { year: '1062年', event: '穆拉比特王朝建城', desc: '柏柏尔人的穆拉比特王朝将马拉喀什定为帝国首都。', worldContext: '此时世界：中国北宋嘉祐七年，王安石即将变法；诺曼征服英格兰前 4 年；塞尔柱帝国鼎盛' },
      { year: '1147年', event: '穆瓦希德王朝', desc: '新王朝重建城市，库图比亚清真寺在此时期建造。', worldContext: '此时世界：中国南宋绍兴十七年；第二次十字军东征刚结束；吴哥窟建成前后；日本平安时代末期' },
      { year: '1269年', event: '马林王朝', desc: '首都迁至非斯，但马拉喀什仍是重要的贸易城市。' },
      { year: '1557年', event: '萨阿德王朝复兴', desc: '马拉喀什重新成为首都，迎来文化和建筑的黄金时代。', worldContext: '此时世界：明朝嘉靖三十六年；奥斯曼苏莱曼大帝末期；英国玛丽一世统治；哥白尼《天体运行论》已出版 14 年' },
  ...
  },
  {
    ...
    timeline: [
      { year: '1325年', event: '特诺奇提特兰建城', desc: '阿兹特克人按照神谕，在看到鹰叼蛇站在仙人掌上的地方建城——一座湖中之岛。', worldContext: '此时世界：中国元泰定二年，元朝进入末期；马可·波罗去世 1 年后；奥斯曼土耳其刚建立 26 年；欧洲文艺复兴初现' },
      { year: '1428年', event: '三方联盟建立', desc: '阿兹特克帝国崛起，特诺奇提特兰成为中美洲最强大的城市。' },
      { year: '1519年', event: '科尔特斯抵达', desc: '西班牙征服者科尔特斯率军进入特诺奇提特兰，被城市的壮观震惊。' },
      { year: '1521年', event: '阿兹特克帝国灭亡', desc: '经过75天围城战，特诺奇提特兰陷落，西班牙人在废墟上建造殖民城市。', worldContext: '此时世界：明朝正德十六年，嘉靖刚即位；麦哲伦船队去年刚抵菲律宾；马丁路德 4 年前钉上九十五条论纲；奥斯曼苏莱曼大帝登基 1 年' },
      { year: '1821年', event: '墨西哥独立', desc: '经过11年独立战争，墨西哥脱离西班牙统治。' },
      { year: '1978年', event: '大神庙遗址发现', desc: '电力工人偶然发现阿兹特克大神庙遗址，就在国家宫殿旁边。', worldContext: '此时世界：中国改革开放前夕十一届三中全会年末召开；美国卡特任内；两伊战争前 2 年；香港地铁开通；苹果 Apple II 已推出一年' },
    ],
    landmarks: [
      { name: '大神庙遗址', era: '阿兹特克·1325年', yearNum: 1325, wiki: 'Templo Mayor', gradient: 'linear-gradient(135deg, #4A2A0A 0%, #8B5A2A 50%, #2A1A00 100%)', desc: '阿兹特克帝国最重要的宗教建筑遗址，1978年偶然出土。金字塔式神庙曾高60米，供奉雨神和战神。', hours: '09:00—17:00，周一闭馆', ticket: {
  ...
  },
  {
    ...
    timeline: [
      { year: '约1438年', event: '印加帝国崛起', desc: '帕查库提征服周边部落，建立南美洲最大的帝国。', worldContext: '此时世界：中国明正统三年，土木堡之变前 11 年；奥斯曼围攻君士坦丁堡前 15 年；欧洲古腾堡即将发明活字印刷；日本应仁之乱前 29 年' },
      { year: '约1450年', event: '马丘比丘建造', desc: '帕查库提下令在乌鲁班巴河谷上方的山脊建造皇家庄园。', worldContext: '此时世界：中国明景泰元年；古腾堡活字印刷刚发明；君士坦丁堡陷落前 3 年；佛罗伦萨美第奇家族柯西莫执政鼎盛' },
      { year: '1533年', event: '西班牙征服印加', desc: '皮萨罗俘获末代印加皇帝，帝国覆灭。马丘比丘因位置偏远未被发现。', worldContext: '此时世界：中国明嘉靖十二年；英王亨利八世刚与罗马教廷决裂；奥斯曼苏莱曼大帝鼎盛期；日本战国时代' },
      { year: '1911年', event: '海勒姆·宾厄姆发现遗址', desc: '耶鲁大学教授在当地农民引导下重新发现了这座"失落之城"。', worldContext: '此时世界：中国辛亥革命爆发、清帝退位前夕；泰坦尼克号下水前 1 年；阿蒙森刚到达南极点；相对论发表 6 年' },

...
const CITIES = [
  ...
  { category: 'secret', text: '珍宝馆往深处走有珍妃井旁的皇家澡堂遗址，90% 游客看完大殿就走错过了' }
      ...
      { name: '长城（八达岭段）', era: '秦·公元前214年', hookShort: '每块砖印着工匠姓名——比 ISO 早 22 个世纪的追溯制。', whyVisit: '北八楼的垛口高 1.7 米，比守军平均身高高一头——射击孔开在胸前，人贴墙就是全身掩体。每块青砖长 37 厘米、重 12 公斤，烧制时印着工匠和州县姓名——这套质量追溯制度比明代早 1600 年就在秦朝用过，比现代 ISO 早 22 个世纪。公元前 214 年蒙恬修第一版长城那年，亚历山大死后 109 年，他在巴克特里亚留下的希腊化王国刚开始铸佛像——东方用夯土断路，西方用石雕融合。八达岭这段是明代重修，砖缝糯米石灰浆比水泥更耐冻。日落前半小时登北十二楼，光掠过墙脊，山脊线像一条等高线打印出来的黑刃。', yearNum: -214, wiki: 'Great Wall of China', wikiImage: 'https://commons.wikimedia.org/wiki/Special:FilePath/The_Great_Wall_of_China_at_Jinshanling.jpg?width=1600', gradient: 'linear-gradient(135deg, #3D5A3E 0%, #8aad96 50%, #1a2d22 100%)', desc: '万里长城始建于春秋战国，总长度超过21,000公里，是人类历史上最伟大的建筑工程之一。', hours: '旺季 07:30—18:00；淡季 08:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '北 5 楼到北 8 楼之间的城墙转折处是最经典构图，避开正午逆光选上午 09:00-10:30 向北拍' // ✓ 锚点：具体方向北 5-8 楼 + 具体时间 09:00-10:30
      ...
      { name: '天坛', era: '明·1420年', hookShort: '站在天心石低声说话，殿堂像给你戴了一副耳机。', whyVisit: '祈年殿三层圆顶下，地面铺成四圈砖：里圈 9 块、二圈 18 块、三圈 27 块、四圈 36 块——每圈都是 9 的倍数，一路到九圈 81 块。皇帝站的那块正中石叫"天心石"，你低声说话，十二根金丝楠木柱构成的殿堂会把你的声音反射回来像戴着一副耳机。1420 年建这座祭坛时，葡萄牙航海家亨利王子刚把船推到非洲西岸——北京在算天的数字，里斯本在算海的距离。回音壁外墙 193 米，贴墙说话能传到对面——这不是玄机，是砖缝被工匠一遍遍糊平、墙面弧度精确到 2 度的结果。冬至清晨的斜光进圜丘坛时，石面会泛出淡淡血红色。', yearNum: 1420, wiki: 'Temple of Heaven', wikiImage: 'https://commons.wikimedia.org/wiki/Special:FilePath/11_Temple_of_Heaven.jpg?width=1600', gradient: 'linear-gradient(135deg, #1A4A7A 0%, #4A90C4 50%, #0d2940 100%)', desc: '天坛是明清两代皇帝祭天祈谷的场所，祈年殿三层蓝色琉璃瓦攒尖顶，纯木榫卯结构，被誉为中国古代建筑的杰作。', hours: '公园 06:00—22:00；景区 08:00—17:30', ticket: {
  ...
  { category: 'secret', text: '二楼楼梯口大理石栏杆上刻着 Halvdan 的北欧海盗涂鸦（9 世纪），在西南角人容易错过' }
      ...
      { name: '蓝色清真寺', era: '奥斯曼·1616年', hookShort: '那片蓝，是矢车菊花瓣烧出来的钴料。', whyVisit: '内墙嵌 21043 块伊兹尼克瓷砖，蓝色是从矢车菊花瓣烧出来的钴料，触感凉润，不是现代化工颜料的亮蓝。六座宣礼塔在当时是违制——整个伊斯兰世界只有麦加大清真寺配六塔，年轻苏丹艾哈迈德一世只好出钱给麦加加盖第七塔平息非议。1616 年清真寺落成那年，莎士比亚在伦敦去世——这一边的权力正把戏剧做成石头。内部四根主柱被伊斯坦布尔人叫作"大象腿"，直径 5 米；礼拜时跪垫呈斜角铺向麦加方向，不与墙平行，走进去会有一瞬间晕。日落宣礼从六塔同时响起，蓝色从瓷砖里渗出来爬上穹顶。', yearNum: 1616, wiki: 'Sultan Ahmed Mosque', gradient: 'linear-gradient(135deg, #0A2A4A 0%, #1A6B9A 50%, #0D3D6B 100%)', desc: '因内部2万余块伊兹尼克蓝色瓷砖得名，六座宣礼塔至今仍是活跃的礼拜场所。', hours: '日出—日落，礼拜期间关闭', ticket: {
  ...
  },
  {
    ...
    text: '山路湿滑 + 夜间无护栏，下雨天和冬季雪后非常滑；登山鞋或防滑底鞋比运动鞋安全' // ✓ 锚点：只有去过才知道 + 具体时间冬季
      ...
      { name: '金阁寺（鹿苑寺）', era: '室町·1397年', hookShort: '足利义满把日本三种权力堆成一栋楼，贴金罩起来。', whyVisit: '三层楼每层建筑样式不同：一层寝殿造（平安贵族）、二层武家造（武士）、三层禅宗佛殿（禅）——足利义满把 1397 年以前日本三种权力形态堆成一栋楼，贴金箔 20 公斤罩起来，是禅宗美学里最罕见的"我想让全世界都看见"。同期欧洲乔托死去 60 年，意大利正进锡耶纳派后期——一边在墙上画金色圣像，一边在湖面贴金色。1950 年一个精神不稳的年轻僧人纵火把它烧了；现在外层的金箔厚 0.45 微米，比 1955 年重建时还厚五倍。镜湖池对岸看过去，上午 10 点到 11 点湖面无风，金阁与倒影成垂直对称，那半小时是全日本被拍得最多的半小时。', yearNum: 1397, wiki: 'Kinkaku-ji', gradient: 'linear-gradient(135deg, #1A3A1A 0%, #C9963A 45%, #0D2010 100%)', desc: '足利义满建造，三层阁楼以金箔贴覆，倒映于镜湖池中。1950年被纵火焚毁，1955年重建。', hours: '09:00—17:00', ticket: {
  ...
  },
  {
    ...
    text: '本丸御殿庭园从东北角度望樱花与天守台石垣同框，是城内不为人知的机位' // ✓ 锚点：具体方向东北 + 具体名字本丸御殿 + 只有去过才知道
      ...
      { name: '清水寺', era: '平安·778年', hookShort: '悬崖舞台 139 根欅木柱撑出，没用一颗铁钉。', whyVisit: '本堂建在悬崖上，前台舞台由 139 根欅木柱子撑出，离崖底 13 米，没用一颗铁钉——榫卯咬合处至今看不见任何腐朽，上一次大修 2017-2020 年换了 35 万片桧木瓦。"从清水舞台跳下"是日语成语，江户时代有 234 人真跳过，活下来 85%（石板上积了三层腐叶作垫）。778 年僧侣延镇建庵时，唐玄宗已驾崩 16 年——清水寺接收了所有从长安流传过来的佛塔形制，却转头发展出舞台这个完全日本的形。音羽瀑布三股泉水分别代表学业、爱情、长寿，日本高中生会选一股喝——三股都喝反而失效，这个规矩 600 年没变。秋天枫红满山时舞台像架在一张烧红的网上。', yearNum: 778, wiki: 'Kiyomizu-dera', gradient: 'linear-gradient(135deg, #3A1A2A 0%, #8B4A6B 50%, #1A0D15 100%)', desc: '建于悬崖之上，本堂前舞台以139根木柱支撑，不用一颗钉子。', hours: '06:00—18:00', ticket: {
  ...
  },
  {
    ...
    text: 'Zócalo 宪法广场东侧正对；从地铁 Zócalo 站出步行 100 米；与大神庙遗址相邻 200 米，是一条动线上的连游' // ✓ 锚点：具体名字 Zócalo + 数字 100 米/200 米
      ...
      { name: '特奥蒂瓦坎', era: '前200年—650年', hookShort: '没人知道这里的人是谁——他们讲什么语言至今不明。', whyVisit: '太阳金字塔高 65 米、底边 220 米——美洲第三大金字塔。鼎盛期（公元 450 年）这里有 20 万人口，是当时世界第六大城市，比同期君士坦丁堡大、比长安小。奇怪的是没人知道这里的人是谁——他们讲什么语言、写什么字、信什么神，至今不明；阿兹特克人千年后看见这座空城，用自己的话称它"Teotihuacan"（众神所生之地）。6 世纪它突然被焚毁、人口消失——全世界最大的消失谜团之一。同期东方北魏时期，洛阳白马寺正翻修；西方罗马刚被西哥特人洗劫——东西两端的帝国都进入崩溃前最后一段繁荣。登顶 248 级台阶，陡到 45 度必须弯腰——这是祭司在神前谦卑的设计。', yearNum: 200, wiki: 'Teotihuacan', gradient: 'linear-gradient(135deg, #4A3A1A 0%, #C9963A 50%, #2A1A00 100%)', desc: '距墨西哥城50公里的古代大都会遗址，太阳金字塔高65米，是美洲第三大金字塔。鼎盛时期人口达20万。', hours: '09:00—17:00', ticket: {
